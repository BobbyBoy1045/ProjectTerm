...
local Window = Library.CreateLib("Project: Terminate 1.0.5", "Sentinel")
...
local Section = Tab:NewSection("Home - Created By Gelatek")
...
Section:NewLabel("Thanks For Using Project Term!")
Section:NewButton("Get Discord Invite", "ButtonInfo", function()
   setclipboard("https://discord.gg/wun5adQYxv")
   Pos()
...
Section3A:NewButton("Gale Fighter", "Created by: makhail07 and KillerDarkness0105", function()
	if game.Players.LocalPlayer.Character:FindFirstChild("TalentlessDumbass") then
	wait(0.15)
	Pos()
	--[[ Name : Gale Fighter ]]--
...
Section3B:NewButton("Hoverboard", "Created by: Unknown", function()
	if game.Players.LocalPlayer.Character:FindFirstChild("TalentlessDumbass") then
	if not game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory") then
		return
		Notification("Missing Hat: MeshPartAccessory >:(")
	end
...
Hat.AccessoryWeld:Destroy()
Align(Hat,Board,Vector3.new(0,0,0),Vector3.new(-45, 90, -90))
for i,v in pairs(Character.Hover:GetChildren()) do
