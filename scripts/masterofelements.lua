...
if _G.BotReanim == true then
  local HatName = "Torso" 
    ...
    local askl2 = askl:FindFirstChild("Torso")
...
v:FindFirstChildOfClass("Humanoid"):BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
end
...
alreadyhit = true
waterb.Anchored = true
Hit = damagealll(0,waterb.Position)
for _,v in pairs(Hit) do
if bluetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
elseif avatarstate then
...
Hit = damagealll(0+rlplosions,rlplosion.Position)
for _,v in pairs(Hit) do
if redtotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
elseif avatarstate then
...
hum.HipHeight = 0
wait(.2)
Hit = damagealll(0,Torso.Position)
for _,v in pairs(Hit) do
if whitetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
elseif avatarstate then
...
for i = 1, 175 do
Hit = damagealll(0,blastpart.Position)
for _,v in pairs(Hit) do
if whitetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
elseif avatarstate then
...
while spinwater do
swait(15)
Hit = damagealll(0,waterlocbrick2.Position)
for _,v in pairs(Hit) do
coroutine.wrap(function()
for i = 1, 10 do
sk = Instance.new("Part",Torso)
...
Hit = damagealll(0,waterlocbrick.Position)
for _,v in pairs(Hit) do
coroutine.wrap(function()
for i = 1, 10 do
sk = Instance.new("Part",Torso)
...
Hit = damagealll(0,shieldlocbrick.Position)
for _,v in pairs(Hit) do
if browntotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
else
...
swait()
if avatarstate then
Hit = damagealll(0,waterball.Position)
else
Hit = damagealll(0,waterball.Position)
end
for _,v in pairs(Hit) do
...
groundrum.Pitch = 1.5
groundrum:Play()
Hit = damagealll(0,biggrassblock.Position)
for _,v in pairs(Hit) do
if browntotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(0,0))
elseif avatarstate then
