...
if not game.Players.LocalPlayer.Character:FindFirstChild("Back Attack Missle Launcher") then
	game.StarterGui:SetCore("SendNotification",{
		Title = "Project: Terminate",
		Text = "Missing Hat.",
	})
...
local script = game:GetObjects("rbxassetid://8356214153")[1]
local MODULE = game:GetObjects("rbxassetid://8356214153")[1]
local CHARACTER = game.Players.LocalPlayer.Character.Rig
...
local Hat = game.Players.LocalPlayer.Character['Back Attack Missle Launcher']
Hat.Handle.AccessoryWeld:Destroy()
Attach(Hat.Handle, BAZOOKA)
