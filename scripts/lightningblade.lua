...
if not game.Players.LocalPlayer.Character:FindFirstChild("PinkCyanSword") then
	game.StarterGui:SetCore("SendNotification",{
		Title = "Project: Terminate",
		Text = "Missing Hat.",
	})
...
local Hat = game.Players.LocalPlayer.Character["PinkCyanSword"].Handle
if Hat:FindFirstChild("AccessoryWeld") then
	Hat.AccessoryWeld:Destroy()
end

Align(Hat,handle,Vector3.new(0, 1.8, -1.8),Vector3.new(45,0,0))
