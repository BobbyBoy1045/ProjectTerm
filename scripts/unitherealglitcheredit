...
if not game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory") and not game.Players.LocalPlayer.Character:FindFirstChild("Evil Aura") then
	game.StarterGui:SetCore("SendNotification",{
		Title = "Project: Terminate",
		Text = "Missing Hats.",
	})
...
local script = game:GetObjects("rbxassetid://8550922484")[1]
...
local enabledshake = true
local enabledchat = true
local ChatGUI 
local WALKSPEEDVALUE = 10 / (hum.WalkSpeed / 16)
local ROOTC0 = cf(0, 0, 0) * angles(RAD(-90), RAD(0), RAD(180))
local NECKC0 = cf(0, 1, 0) * angles(RAD(-90), RAD(0), RAD(180))
local RIGHTSHOULDERC0 = cf(-0.5, 0, 0) * angles(RAD(0), RAD(90), RAD(0))
local LEFTSHOULDERC0 = cf(0.5, 0, 0) * angles(RAD(0), RAD(-90), RAD(0))
local top = Instance.new("Shirt", hed)
top.ShirtTemplate = "rbxassetid://1533635803"
top.Name = "Cloth"
local bottom = Instance.new("Pants", hed)
bottom.PantsTemplate = "rbxassetid://1460022985"
bottom.Name = "Cloth"
if plr.Character:FindFirstChild("Bullet") then
...
if Noob~=nil then
coroutine.resume(coroutine.create(function()
local FV = Instance.new("BoolValue", Noob)
FV.Name = "CameraShake"
...
modet.Font = "Fantasy"
modet.TextStrokeColor3 = bc("Institutional white").Color
modet.TextColor3 = bc("Really black").Color
modet.Text = "SOLITUDE"
...
local gl = Instance.new("Model",char)
...
fr.BorderColor3 = BrickColor.new("Institutional white").Color
...
fr2.BorderColor3 = BrickColor.new("Really black").Color
fr2.BackgroundColor3 = BrickColor.new("Institutional white").Color
fr2.Position = UDim2.new(0, 0, 0.85, 0)
local fr3 = fr:Clone()
fr3.Parent = fullscreenz
fr3.BorderColor3 = BrickColor.new("Institutional white").Color
fr3.BackgroundColor3 = BrickColor.new("Really black").Color
fr3.Position = UDim2.new(0, 0, 0, 0)
local fr4 = fr:Clone()
fr4.Parent = fullscreenz
fr4.BorderColor3 = BrickColor.new("Really black").Color
fr4.BackgroundColor3 = BrickColor.new("Institutional white").Color
fr4.Position = UDim2.new(0, 0, 0.05, 0)
local midr = fr:Clone()
...
glw.ImageColor3 = BrickColor.new("Institutional white").Color
...
glw2.ImageColor3 = BrickColor.new("Institutional white").Color
...
techc2.ImageColor3 = BrickColor.new("Institutional white").Color
...
nedx.TextColor3 = BrickColor.new("Really black").Color
nedx.TextStrokeColor3 = BrickColor.new("Institutional white").Color
...
local nedc = Instance.new("TextLabel",fullscreenz)
nedc.ZIndex = 2
nedc.Font = "SciFi"
nedc.BackgroundTransparency = 1
nedc.BorderSizePixel = 0.65
nedc.Size = UDim2.new(0.25,0,0.1,0)
nedc.Position = UDim2.new(0.002, 0,0.05, 0)
nedc.TextColor3 = BrickColor.new("Really black").Color
nedc.TextStrokeColor3 = BrickColor.new("Institutional white").Color
nedc.TextScaled = true
nedc.TextStrokeTransparency = 0
nedc.Text = "Shakes: Enabled"
nedc.TextSize = 24
nedc.Rotation = 5
nedc.TextXAlignment = "Center"
nedc.TextYAlignment = "Bottom"

local nedo = Instance.new("TextLabel",fullscreenz)
nedo.ZIndex = 2
nedo.Font = "SciFi"
nedo.BackgroundTransparency = 1
nedo.BorderSizePixel = 0.65
nedo.Size = UDim2.new(0.25,0,0.1,0)
nedo.Position = UDim2.new(0.74, 0,0.05, 0)
nedo.TextColor3 = BrickColor.new("Really black").Color
nedo.TextStrokeColor3 = BrickColor.new("Institutional white").Color
nedo.TextScaled = true
nedo.TextStrokeTransparency = 0
nedo.Text = "Boss Chat: Enabled"
nedo.TextSize = 24
nedo.Rotation = -5
nedo.TextXAlignment = "Center"
nedo.TextYAlignment = "Bottom"
...
sngy.TextColor3 = BrickColor.new("Really black").Color
sngy.TextStrokeColor3 = BrickColor.new("Institutional white").Color
sngy.TextScaled = true
sngy.TextStrokeTransparency = 0
sngy.Text = string.upper("Astronaut 13")
sngy.TextSize = 24
sngy.Rotation = 0
sngy.TextXAlignment = "Center"
sngy.TextYAlignment = "Bottom"

local cred = Instance.new("TextLabel",fullscreenz)
cred.ZIndex = 2
cred.Font = "Arcade"
cred.BackgroundTransparency = 1
cred.BorderSizePixel = 0.65
cred.Size = UDim2.new(0.35,0,0.2,0)
cred.Position = UDim2.new(0.325, 0,0, 0)
cred.TextColor3 = BrickColor.new("Really black").Color
cred.TextStrokeColor3 = BrickColor.new("Institutional white").Color
cred.TextScaled = true
cred.TextStrokeTransparency = 0
cred.Text = "UNITHEREAL GLITCHER EDIT BY GIAN0508"
cred.TextSize = 24
cred.Rotation = 0
cred.TextXAlignment = "Center"
cred.TextYAlignment = "Bottom"
...
local g1 = script.glove:Clone()
g1.Parent = gl
CreateWeld(g1,g1.hitbox,ra,0,0,0,math.rad(0),math.rad(0),math.rad(0),0,0,0,math.rad(0),math.rad(0),math.rad(0))

local g2 = script.glove2:Clone()
g2.Parent = gl
CreateWeld(g1,g2.hitbox,la,0,0,0,math.rad(0),math.rad(0),math.rad(0),0,0,0,math.rad(0),math.rad(180),math.rad(0))

local pandora = script.pandora:Clone()
pandora.Parent = hed
CreateWeld(hed,pandora.hitboxy,hed,0,0,0,math.rad(0),math.rad(0),math.rad(0),0,0,0,math.rad(0),math.rad(0),math.rad(0))

local calsword = script.calsword:Clone()
calsword.Parent = ra
CreateWeld(ra,calsword.hitboxy,ra,0,0,0,math.rad(0),math.rad(0),math.rad(0),0,0,0,math.rad(0),math.rad(0),math.rad(0))
...
local MRCL = BrickColor.new("Institutional white")
local MRCL2 = BrickColor.new("Really black")
local MAINRUINCOLOR = MRCL.Color
...
------
function BossChat(text,color,watval)
	for i,v in pairs(game:GetService("Players"):GetPlayers()) do
		local parent = v:FindFirstChildOfClass'PlayerGui' or v:FindFirstChildOfClass'Backpack' or v.Character
		local WingSine=0;
		local scr = ChatGUI:Clone();
		local S = setmetatable({},{__index = function(s,i) return game:service(i) end})
		local this_is_useless_lmao = watval
		scr.Parent=parent
		scr.Text.Value=text
		scr.Font.Value="Arcade"
		scr.Mode.Value=ned.Text
		scr.Color1.Value= Color3.new(0,0,0)
		scr.Color2.Value= color
		scr.Color3.Value= Color3.new(0,0,0)
		scr.Color4.Value= color
		scr.Disabled=false
coroutine.resume(coroutine.create(function()
while true do
swait()
if chaosmode == true then
scr.Chat.BG.Text.Rotation = math.random(-1,1)
scr.Chat.BG.Mode.Rotation = math.random(-1,1)
scr.Chat.BG.Mode.Text = ned.Text
scr.Chat.BG.Position = scr.Chat.BG.Position + UDim2.new(0,math.random(-1,1)/5,0,math.random(-1,1)/5)
scr.Chat.BG.Position = scr.Chat.BG.Position + UDim2.new(0,math.random(-1,1)/5,0,math.random(-1,1)/5)
scr.Chat.BG.Text.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
scr.Chat.BG.Mode.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
end
if chaosmode2 == true then
scr.Chat.BG.Text.Rotation = math.random(-1,1)
scr.Chat.BG.Mode.Rotation = math.random(-1,1)
...
scr.Chat.BG.Mode.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
		...
		S.Debris:AddItem(scr,10+#text*3)
	end
end
...
nedc.TextColor3 = col1
nedc.TextStrokeColor3 = col2
nedo.TextColor3 = col1
nedo.TextStrokeColor3 = col2
...
cred.TextColor3 = col1
cred.TextStrokeColor3 = col2
fr.BorderColor3 = col1
fr.BackgroundColor3 = col2
fr2.BorderColor3 = col2
fr2.BackgroundColor3 = col1
fr3.BorderColor3 = col1
fr3.BackgroundColor3 = col2
fr4.BorderColor3 = col2
fr4.BackgroundColor3 = col1
...
function newbosschatfunc(text,color1,color2,delay)
	if enabledchat ~= false then
	for _,v in next, game:service'Players':players() do
		coroutine.wrap(function()
			if(script:FindFirstChild'ChatGUI' and v.Character)then
				local cha = script.ChatGUI:Clone()
				cha.Color1.Value=color1
				cha.Color2.Value=color2
				cha.Text.Value=text
				cha.Ghghghghgh.Value=delay
				cha.ModeName.Value=ned.Text
				cha.Music.Value=kan
...
swait()
if chaosmode == true then
cha.NewDialog.H.US.Text = ned.Text
cha.NewDialog.H.H.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
cha.NewDialog.H.BackgroundColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
cha.NewDialog.H.US.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
end
if chaosmode2 == true then
cha.NewDialog.H.US.Text = ned.Text
cha.NewDialog.H.H.TextStrokeColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
...
newbosschatfunc(message,MRCL.Color,MRCL2.Color,200)
end)
...
function Damagefunc(Part, hit, minim, maxim, knockback, Type, Property, Delay, HitSound, HitPitch)
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Head") ~= nil then
    ...
    local c = Create("ObjectValue")({
      Name = "creator",
      Value = game:GetService("Players"):FindFirstChild(script.owner.Value),
      Parent = h
    })
...
function createChaosCircle(size,parent,color)
local bgui = Instance.new("BillboardGui",parent)
bgui.Size = UDim2.new(size, 0, size, 0)
local imgc = Instance.new("ImageLabel",bgui)
imgc.BackgroundTransparency = 1
...
imgc.Size = UDim2.new(1,0,1,0)
imgc.Image = "rbxassetid://997291547" --997291547,521073910
imgc.ImageColor3 = Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255))
return bgui,imgc
end
...
for i, v in pairs(gl.glove:GetDescendants()) do
if v:IsA("UnionOperation") then
v.Color = one
v.Material = "Neon"
end
end
ra.calsword.MeshPart.Color = one
ra.calsword.MeshPart2.Color = two
for i, v in pairs(gl.glove2:GetDescendants()) do
if v:IsA("UnionOperation") then
v.Color = two
v.Material = "Neon"
end
...
function desstomp()
	attack = true
	hum.WalkSpeed = 0
newbosschatfunc("To the depths of hell...",MRCL.Color,MRCL2.Color,200)
for i = 0, 8, 0.1 do
swait()
...
sphere(5,"Add",root.CFrame*CFrame.new(0,-2.9,0),vt(0,0,0),1,MRCL)
sphere(10,"Add",root.CFrame*CFrame.new(0,-2.9,0),vt(0,0,0),2,MRCL)
sphere(1,"Add",root.CFrame*CFrame.new(0,-2.9,0),vt(200,0.1,200),0.01,MRCL)
newbosschatfunc("YOU GO!",MRCL.Color,MRCL2.Color,200)
shakes(0.2,0.3)
for i = 0, 6, 0.1 do
swait()
slash(5,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(1,0.01,1),math.random(-45,45)/10,MRCL2)
slash(5,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(1,0.01,1),math.random(-45,45)/10,MRCL2)
sphereMK(2.5,0.75,"Add",root.CFrame*CFrame.new(math.random(-105,105),-5,math.random(-105,105))*CFrame.Angles(math.rad(90 + math.rad(math.random(-45,45))),math.rad(math.random(-45,45)),math.rad(math.random(-45,45))),2.5,2.5,25,-0.025,MRCL,0)
sphereMK(2.5,0.75,"Add",root.CFrame*CFrame.new(math.random(-105,105),-5,math.random(-105,105))*CFrame.Angles(math.rad(90 + math.rad(math.random(-45,45))),math.rad(math.random(-45,45)),math.rad(math.random(-45,45))),2.5,2.5,25,-0.025,MRCL,0)
...
if radm == 1 then
newbosschatfunc("YOU WONT BE NECCESSARY.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("YOUR EXISTANCE WILL BE GONE.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("DIE!",MRCL.Color,MRCL2.Color,200)
end
for i = 0,2,0.1 do
swait()
...
function whofuckingcares()
local random = math.random(1,10)
if random == 1 then
newbosschatfunc("why",MRCL.Color,MRCL2.Color,200)	
elseif random == 2 then
newbosschatfunc("yu postd cring",MRCL.Color,MRCL2.Color,200)	
elseif random == 3 then
newbosschatfunc("not funny didnt laugh",MRCL.Color,MRCL2.Color,200)	
elseif random == 4 then
newbosschatfunc("i hate you",MRCL.Color,MRCL2.Color,200)	
elseif random == 5 then
newbosschatfunc("im the best error around here",MRCL.Color,MRCL2.Color,200)	
elseif random == 6 then
newbosschatfunc("stop",MRCL.Color,MRCL2.Color,200)	
elseif random == 7 then
newbosschatfunc("star glitchers has hit a new low",MRCL.Color,MRCL2.Color,200)	
elseif random == 8 then
newbosschatfunc("fat",MRCL.Color,MRCL2.Color,200)	
elseif random == 9 then
newbosschatfunc("deji literally dies lol",MRCL.Color,MRCL2.Color,200)	
elseif random == 10 then
newbosschatfunc("hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh",MRCL.Color,MRCL2.Color,200)	
end
end
...
CFuncs["Sound"].Create("rbxassetid://847061203", root, 2.5,1)
for i = 0, 9 do
sphereMK(3,0.25,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,10,-0.01,MRCL,0)
end
for i = 0, 24 do
PixelBlock(1,math.random(4,8),"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),3,3,3,0.06,MRCL,0)
end
sphere(3,"Add",root.CFrame,vt(0,0,0),0.25,MRCL)
local originalpos = root.CFrame
RootPart.CFrame = targetted.Head.CFrame * CFrame.new(0,-2,2)
for i = 0, 9 do
sphereMK(3,0.25,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,10,-0.01,MRCL,0)
...
targetted:FindFirstChildOfClass("Humanoid").CameraOffset = vt(math.random(-10,10)/5,math.random(-10,10)/5,math.random(-10,10)/5)
for i = 0, 2 do
slash(5,5,true,"Round","Add","Out",targetted.Head.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(50,350)/250,MRCL)
end
symbolizeBlink(targetted.Head,0,2092248396,Color3.new(1,0,0),math.random(3,35),0,0,0,targetted.Head,true,math.random(3,9),0.25)
for i,v in pairs(targetted:GetChildren()) do
if v:IsA("Part") or v:IsA("MeshPart") then
...
for i = 0, 49 do
sphere2(math.random(10,75)/10,"Add",targetted.Head.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,5,5),-0.05,50,-0.05,MRCL)
slash(math.random(10,30)/15,5,true,"Round","Add","Out",targetted.Head.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(40,500)/250,MRCL)
end
CFuncs["EchoSound"].Create("rbxassetid://824687369", char, 2, 0.9,0,10,0.25,0.5,1)
for i = 0, 1 do
CFuncs["Sound"].Create("rbxassetid://221920821", targetted.Head, 5,0.9)
...
sphere2(5,"Add",root.CFrame*CFrame.new(0,-3,0),vt(10,1,10),2,0.01,2,MRCL,MRCL.Color)
for i = 0, 24 do
slash(math.random(15,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-5,5)),math.rad(math.random(-5,5))),vt(0.01,0.01,0.01),math.random(200,500)/250,MRCL)
end
local rrot = 0
coroutine.resume(coroutine.create(function()
for i = 0, 4 do
...
MagniDamage(xd, 30, 39*rrot/5,65*rrot/2.5, 0, "Normal")
for i = 0, 9 do
slash(math.random(15,50)/10,5,true,"Round","Add","Out",xa.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01,0.01,0.01),math.random(50,125)/250,MRCL)
slash(math.random(15,50)/10,5,true,"Round","Add","Out",xb.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01,0.01,0.01),math.random(50,125)/250,MRCL)
slash(math.random(15,50)/10,5,true,"Round","Add","Out",xc.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01,0.01,0.01),math.random(50,125)/250,MRCL)
slash(math.random(15,50)/10,5,true,"Round","Add","Out",xd.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01,0.01,0.01),math.random(50,125)/250,MRCL)
end
block(1.5,"Add",xa.CFrame*CFrame.new(0,-10,0),vt(30,30,30),0.3,0.3,0.3,keptcolor,keptcolor.Color)
block(1.5,"Add",xb.CFrame*CFrame.new(0,-10,0),vt(30,30,30),0.3,0.3,0.3,keptcolor,keptcolor.Color)
block(1.5,"Add",xc.CFrame*CFrame.new(0,-10,0),vt(30,30,30),0.3,0.3,0.3,keptcolor,keptcolor.Color)
...
sphere2(2,"Add",xc.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(25,1,25),0.05,1.5,0.05,keptcolor,keptcolor.Color)
sphere2(2,"Add",xd.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(25,1,25),0.05,1.5,0.05,keptcolor,keptcolor.Color)
sphere2(4,"Add",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30,1,30),0.05,1.5,0.05,MRCL,Color3.new(0,0,0))
sphere2(4,"Add",xb.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30,1,30),0.05,1.5,0.05,MRCL,Color3.new(0,0,0))
sphere2(4,"Add",xc.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30,1,30),0.05,1.5,0.05,MRCL,Color3.new(0,0,0))
sphere2(4,"Add",xd.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30,1,30),0.05,1.5,0.05,MRCL,Color3.new(0,0,0))
game:GetService("Debris"):AddItem(xa, 5)
game:GetService("Debris"):AddItem(xb, 5)
game:GetService("Debris"):AddItem(xc, 5)
game:GetService("Debris"):AddItem(xd, 5)
...
function EndGROUND()
	attack = true
hum.WalkSpeed = 0
newbosschatfunc("THIS IS IT!",MRCL.Color,MRCL2.Color,200)
--CFuncs["Sound"].Create("rbxassetid://838392947", root, 10, 1)
CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 1)
...
hum.CameraOffset = vt(math.random(-10,10)/100,math.random(-10,10)/100,math.random(-10,10)/100)
block(10,"Add",rarm.CFrame*CFrame.new(0,-6,0),vt(4,4,4),0.05,0.05,0.05,MRCL,MRCL.Color)
slash(math.random(25,50)/10,5,true,"Round","Add","Out",rarm.CFrame*CFrame.new(0,-6,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.1,0.01,0.1),-0.1,MRCL)
RH.C0=clerp(RH.C0,cf(1,-0.15,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(-15),math.rad(-20)),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(1),math.rad(20)),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0.25,-0.05)*angles(math.rad(-20),math.rad(0),math.rad(30)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(20),math.rad(0),math.rad(-30)),.1)
...
MagniDamage(xa, 30*bonus, 78*bonus,99*bonus, 0, "Normal")
for i = 0, 9 do
slash(math.random(15,50)/10,5,true,"Round","Add","Out",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(0.01*bonus,0.01,0.01*bonus),math.random(50,125)/250*bonus,MRCL)
end
block(1.5,"Add",xa.CFrame*CFrame.new(0,-10,0),vt(30*bonus,30*bonus,30*bonus),0.3,0.3,0.3,keptcolor,keptcolor.Color)
sphere2(2,"Add",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(25*bonus,1,25*bonus),0.05*bonus,1.5*bonus,0.05*bonus,keptcolor,keptcolor.Color)
sphere2(4,"Add",xa.CFrame*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),vt(30*bonus,1,30*bonus),0.05*bonus,1.5*bonus,0.05*bonus,MRCL,Color3.new(0,0,0))
game:GetService("Debris"):AddItem(xa, 5)
coroutine.resume(coroutine.create(function()
for i = 0, 19 do
swait()
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Dont make this too easy for you.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Heavenly Disks!",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Take it!",MRCL.Color,MRCL2.Color,200)
end
...
if radm == 1 then 
newbosschatfunc("GET OUT OF MY SIGHT!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then 
newbosschatfunc("I'LL KILL ALL OF YOU!",MRCL.Color,MRCL2.Color,200)
end
...
local radm = math.random(1,2)
if radm == 1 then 
newbosschatfunc("SHATTER!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then 
newbosschatfunc("I'LL ANNIHIALATE YOU ALL!",MRCL.Color,MRCL2.Color,200)
end
local keptcolor = MRCL
for i = 0,8,0.1 do
swait()
...
CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 0.5)
CFuncs["EchoSound"].Create("rbxassetid://1718412034", char, 4, 1,0,10,0.15,0.5,1)
newbosschatfunc("OMEGA SHATTER!!!!!",MRCL.Color,MRCL2.Color,200)
local keptcolor = MRCL
for i = 0,8,0.1 do
swait()
hum.CameraOffset = vt(math.random(-10,10)/100,math.random(-10,10)/100,math.random(-10,10)/100)
slash(math.random(10,200)/10,20,true,"Round","Add","Out",root.CFrame*CFrame.new(0,100,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(5,0.01,5),-2,BrickColor.random())
block(2.5,"Add",root.CFrame*CFrame.new(0,100,0),vt(0,0,0),2,2,2,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
RH.C0=clerp(RH.C0,cf(1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-15 - 2 * math.cos(sine / 32))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(15 + 2 * math.cos(sine / 32))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0.15 + 0.02 * math.cos(sine / 32),-0.1 + 0.05 * math.cos(sine / 32))*angles(math.rad(-15 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(0)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-25 - 2 * math.cos(sine / 37)),math.rad(0 + 1 * math.cos(sine / 58)),math.rad(0 + 2 * math.cos(sine / 53))),.1)
...
sphere2(2,"Add",root.CFrame,vt(1,1,1),4,4,4,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
sphere2(2,"Add",root.CFrame,vt(1,1,1),8,8,8,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
sphere2(2,"Add",root.CFrame,vt(1,1,1),16,16,16,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
sphere2(2,"Add",root.CFrame,vt(1,1,1),32,32,32,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
CFuncs["Sound"].Create("rbxassetid://1841058541", root, 10,1)
CFuncs["Sound"].Create("rbxassetid://2095993595", char, 5,0.8)
CFuncs["Sound"].Create("rbxassetid://1841058541", char, 5,1)
shakes(0.5,0.5)
...
CFuncs["Sound"].Create("rbxassetid://675172759", xa, 7,math.random(100,200)/200)
sphere2(2.5,"Add",xa.CFrame,vt(1,1,1),2,2,2,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
sphere2(2.5,"Add",xa.CFrame,vt(1,1,1),4,4,4,BrickColor.random(),Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)))
MagniDamage(xa, 60, 9999,99999, 0, "Normal")
end
end))
attack = false
...
local PLLLL = game.Players.LocalPlayer.Character

PLLLL.MeshPartAccessory.Name = "1"
PLLLL.MeshPartAccessory.Name = "2"
PLLLL.MeshPartAccessory.Name = "3"
PLLLL.MeshPartAccessory.Name = "4"
PLLLL.BladeMasterAccessory.Name = "5"
PLLLL.ShadowBladeMasterAccessory.Name = "6"
PLLLL["Evil Aura"].Name = "7"
local Hat1 = PLLLL:FindFirstChild("1").Handle
local Hat2 = PLLLL:FindFirstChild("2").Handle
local Hat3 = PLLLL:FindFirstChild("3").Handle
local Hat4 = PLLLL:FindFirstChild("4").Handle
local Hat5 = PLLLL:FindFirstChild("5").Handle
local Hat6 = PLLLL:FindFirstChild("6").Handle
local Hat7 = PLLLL:FindFirstChild("7").Handle
-- lwing1
Hat1.AccessoryWeld:Destroy()
Align(Hat1,lwing1,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat2.AccessoryWeld:Destroy()
Align(Hat2,lwing2,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat5.AccessoryWeld:Destroy()
Align(Hat5,lwing3,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat3.AccessoryWeld:Destroy()
Align(Hat3,rwing1,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat4.AccessoryWeld:Destroy()
Align(Hat4,rwing2,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat6.AccessoryWeld:Destroy()
Align(Hat6,rwing3,Vector3.new(1,1,0),Vector3.new(-0, -0, -45))
Hat7.AccessoryWeld:Destroy()
Align(Hat7,mw2.Diamond,Vector3.new(0,0,0),Vector3.new(-0, 90, 0))
...
local keptcolor2 = MRCL2
newbosschatfunc("Begone.",MRCL.Color,MRCL2.Color,200)
for i = 0,3,0.1 do
swait()
slash(math.random(80,90),90,true,"Round","Add","In",ra.CFrame*CFrame.new(0,0,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-90,90))),vt(0.01*2/60,0.002,0.01*2/60),math.random(5,20)/250,MRCL)
...
MagniDamage(ra, 50, 100,200, 0, "Normal")
shakes(1,0.6)
for i = 0,9,0.1 do
swait()
slash(math.random(40,70)/10,5,true,"Round","Add","Out",ra.CFrame*CFrame.new(0,0,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-90,90))),vt(0.01*2/60,0.002,0.01*2/60),math.random(5,20)/250,MRCL)
RH.C0=clerp(RH.C0,cf(1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(-5),math.rad(90),math.rad(-5)),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(5),math.rad(-90),math.rad(5)),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0.01 + 0.001 * math.cos(sine / 32),0 + 0.05 * math.cos(sine / 32))*angles(math.rad(2 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(-20 - 1 * math.cos(sine / 44))),.1)
...
hum.WalkSpeed = 0
	...
	local radm = math.random(1,3)
if radm == 1 then 
newbosschatfunc("Nothing personal, kid.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then 
newbosschatfunc("Dodge this then!",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then 
newbosschatfunc("Good luck recovering from this!",MRCL.Color,MRCL2.Color,200)
end	
...
vel.position = root.CFrame.p + vt(0,200,0)
wait(0.5)
local orb = rngb:Clone()
orb.Parent = char
orb.Transparency = 0
...
rval = rval + math.random(30,40)
obj1.Transparency = obj1.Transparency - 0.05
obj1.Size = obj1.Size + vt(15,15,10)
obj1.CFrame = root.CFrame*CFrame.new(0,1,-5)*CFrame.Angles(math.rad(0),math.rad(0),math.rad(rval))
orb.CFrame = root.CFrame*CFrame.new(0,0.5,0) + root.CFrame.lookVector*11.5
orbe.CFrame = root.CFrame*CFrame.new(0,0.5,0) + root.CFrame.lookVector*11.5
            RootJoint.C0 = clerp(RootJoint.C0,RootCF*cf(0,0,0)* angles(math.rad(0),math.rad(0),math.rad(90)),0.3)
...
orb.Transparency = 1
orb.CFrame = root.CFrame*CFrame.new(0,0.5,0) + root.CFrame.lookVector*5
CFuncs["Sound"].Create("rbxassetid://294188875", char, 1, 0.5)
local a = Instance.new("Part",Character)
	a.Name = "Direction"	
	a.Anchored = true
	a.BrickColor = bc("White")
...
ba.Transparency = 1
	...
	local ray = Ray.new(
	    orb.CFrame.p,                           -- origin
	    (mouse.Hit.p - orb.CFrame.p).unit * 5000 -- direction
	) 
	local ignore = Character
	local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
	a.BottomSurface = 10
...
local msh = Instance.new("SpecialMesh",a)
msh.MeshType = "Cylinder"
msh.Scale = vt(1,5*30,5*30)
local msh2 = Instance.new("SpecialMesh",a2)
msh2.MeshType = "Cylinder"
msh2.Scale = vt(1,6*30,6*30)
local eff = Instance.new("ParticleEmitter",ba)
eff.Texture = "rbxassetid://2344870656"
eff.LightEmission = 1
eff.Color = ColorSequence.new(Color3.new(1,1,1))
...
eff2.Color = ColorSequence.new(Color3.new(r/255,g/255,b/255))
obj1.CFrame = root.CFrame*CFrame.new(0,1,-5)*CFrame.Angles(math.rad(0),math.rad(0),math.rad(rval))
obj1.Size = obj1.Size - vt(0.25,0.25,0.17)
a2.Color = Color3.new(r/255,g/255,b/255)
orb.CFrame = root.CFrame*CFrame.new(0,0.5,0) + root.CFrame.lookVector*4
orbe.CFrame = root.CFrame*CFrame.new(0,0.5,0) + root.CFrame.lookVector*4
ray = Ray.new(
...
msh.Scale = msh.Scale - vt(0,0.05*5,0.05*5)
msh2.Scale = msh2.Scale - vt(0,0.06*5,0.06*5)
slash(5,3,true,"Round","Add","Out",ba.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.10,0.10,0.10),math.random(100,1000)/250,ba.BrickColor)
sphereMK(5,1.5,"Add",ba.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),50,50,300,-0.15,MRCL,0)
sphereMK(5,1.5,"Add",ba.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),50,50,300,-0.15,MRCL,0)
sphereMK(5,2.5,"Add",ba.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),7,7,500,-0.03,MRCL,0)
...
newbosschatfunc("Nothing personal, kid.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then 
newbosschatfunc("Good luck recovering from that!",MRCL.Color,MRCL2.Color,200)
end	
CFuncs["Sound"].Create("rbxassetid://136007472", root, 7, 1.25)
for i = 0,4,0.1 do
		swait()
...
sphere2(2,"Add",root.CFrame*CFrame.new(0,30,0) + root.CFrame.lookVector*1,vt(3,3,3),0.6,0.6,0.6,keptcolor)
sphere2(4,"Add",root.CFrame*CFrame.new(0,30,0) + root.CFrame.lookVector*1,vt(3,3,3),0.6,0.6,0.6,keptcolor)
sphere2(3,"Add",root.CFrame*CFrame.new(0,30,0) + root.CFrame.lookVector*1,vt(1,10000,1),0.06,0.06,0.06,keptcolor)
local elocacenter = CreateParta(char,1,1,"SmoothPlastic",BrickColor.random())
elocacenter.Anchored = true
elocacenter.CFrame = root.CFrame*CFrame.new(0,150,0)
local eloca1 = CreateParta(elocacenter,1,1,"SmoothPlastic",BrickColor.random())
...
lb.Transparency = 0
lb.Size = vt(1,1,1)
lb.CFrame = elocacenter.CFrame*CFrame.new(math.random(-350,350),0,math.random(-350,350))*CFrame.Angles(math.rad(-90 + math.random(-15,15)),0,math.rad(math.random(-15,15)))
lb.Anchored = false
lb.Parent = char
local thingery = Instance.new("SpecialMesh",lb)
     thingery.MeshType = "Sphere"
...
tril.Rate = 500000
tril.Lifetime = NumberRange.new(0.5,1)
tril.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,50,0),NumberSequenceKeypoint.new(1,0,0)})
tril.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.1,0.5,0),NumberSequenceKeypoint.new(0.8,0,0),NumberSequenceKeypoint.new(1,1,0)})
tril.Speed = NumberRange.new(0,10)
tril.Drag = 5
tril.Rotation = NumberRange.new(-500,500)
...
MagniDamage(lb, 60, 4500,85000, 0, "Normal")
coroutine.resume(coroutine.create(function()
for i, v in pairs(FindNearestHead(lb.CFrame.p, 100)) do
if v:FindFirstChild('Head') then
dmg(v)
end
end
...
lb.Transparency = 0
lb.Size = vt(1,1,1)
lb.CFrame = elocacenter.CFrame*CFrame.new(math.random(-700,700),0,math.random(-700,700))*CFrame.Angles(math.rad(-90 + math.random(-15,15)),0,math.rad(math.random(-15,15)))
lb.Anchored = false
 lb.Parent = char
local thingery = Instance.new("SpecialMesh",lb)
     thingery.MeshType = "Sphere"
thingery.Scale = vt(100,100,100)
game:GetService("Debris"):AddItem(lb, 10)
  local bv = Instance.new("BodyVelocity")
  bv.maxForce = Vector3.new(1e9, 1e9, 1e9)
  bv.velocity = lb.CFrame.lookVector*math.random(350,650)
  bv.Parent = lb
sphere(2.5,"Add",lb.CFrame,vt(200,200,0),0.25,keptcolor)
sphere(5,"Add",lb.CFrame,vt(200,200,0),0.5,keptcolor)
CFuncs["Sound"].Create("rbxassetid://633627961",lb, 10, 1)
CFuncs["Sound"].Create("rbxassetid://1002081188", lb, 10, 1)
CFuncs["Sound"].Create("rbxassetid://741272936", lb, 10, 1)
CFuncs["Sound"].Create("rbxassetid://1192402877", lb, 10, 1)
...
CFuncs["EchoSound"].Create("rbxassetid://675172759", lb, 8, 0.8,0,10,0.15,0.5,1)
CFuncs["EchoSound"].Create("rbxassetid://782200047", lb, 10, 1.1,0,10,0.15,0.5,1)
MagniDamage(lb, 100, 4500,85000, 0, "Normal")
coroutine.resume(coroutine.create(function()
for i, v in pairs(FindNearestHead(lb.CFrame.p, 50)) do
if v:FindFirstChild('Head') then
dmg(v)
...
MRCL = BrickColor.new("Pink")
MRCL2 = BrickColor.new("Hot pink")
storehumanoidWS = 100
hum.Walkspeed = 100
rainbowmode = false
chaosmode = false
RecolorTextAndRename("Love <3",MRCL2.Color,MRCL.Color,"Cartoon","Xi - Aragami")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorTextAndRename("LOVE",MRCL2.Color,MRCL.Color,"Cartoon","Xi - Aragami")
...
chaosmode = false
chaosmode2 = false
newThemeCust("rbxassetid://183142252",0,1,2.15)
newbosschatfunc("Riddle me this..",MRCL.Color,MRCL2.Color,200)
    for i = 0, 14, .1 do
        swait()
...
newbosschatfunc("Riddle me that..",MRCL.Color,MRCL2.Color,200)
    for i = 0, 12, .1 do
        swait()
        RH.C0=clerp(RH.C0,cf(1,-1-.2*math.cos(sine/16),0)*angles(0,math.rad(90),0),.1)
        LH.C0=clerp(LH.C0,cf(-1,-1-.2*math.cos(sine/16),.05)*angles(0,math.rad(15),0)*angles(math.rad(0),math.rad(-90),math.rad(0)),.1)
    ...
    newbosschatfunc("Who's afraid of the big black..",MRCL.Color,MRCL2.Color,200)
    for i = 0, 16, .1 do
        swait()
        RH.C0=clerp(RH.C0,cf(1,-1-.2*math.cos(sine/16),0)*angles(0,math.rad(90),0),.1)
        LH.C0=clerp(LH.C0,cf(-1,-1-.2*math.cos(sine/16),.05)*angles(0,math.rad(15),0)*angles(math.rad(0),math.rad(-90),math.rad(0)),.1)
    ...
    ModeOfGlitch = 84
    RecolorTextAndRename("THE BIG BLACK",MRCL.Color,MRCL2.Color,"Fantasy","The Quick Brown Fox - The Big Black")
    RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
    shakes(0.4,1)
...
if rando == 1 then
newbosschatfunc("Hehe..~",MRCL.Color,MRCL2.Color,200)
elseif rando == 2 then
newbosschatfunc("I love you..~",MRCL.Color,MRCL2.Color,200)
elseif rando == 3 then
newbosschatfunc("Mmm..~",MRCL.Color,MRCL2.Color,200)
end
CFuncs["Sound"].Create("rbxassetid://543623779", tors, 2.5, 1)
...
function ascendCalamity()
attack = true
MRCL = BrickColor.new("Lilac")
MRCL2 = BrickColor.new("Alder")
RecolorTextAndRename("CATASTROPHE",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - Universal Collapse")
newbosschatfunc("It's not over yet kid,",MRCL.Color,MRCL2.Color,200)
hum.WalkSpeed = 0
newThemeCust("rbxassetid://2206245579",0,1.01,1.75)
MAINRUINCOLOR = MRCL
local vel = Instance.new("BodyPosition", root)
vel.P = 25000
vel.D = 1000
...
chaosmode = false
chaosmode2 = false
RecolorTextAndRename("CATASTROPHE HAS AWOKEN!",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - Universal Collapse")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorTextAndRename("CATASTROPHE",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - Universal Collapse")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end

function InsanityAwakening()
attack = true
hum.WalkSpeed = 0
MAINRUINCOLOR = MRCL
newThemeCust("rbxassetid://1566197356",0,1.01,2.25)
local vel = Instance.new("BodyPosition", root)
vel.P = 10000
vel.D = 1000
vel.maxForce = Vector3.new(50000000000, 10e10, 50000000000)
...
for i = 0, 50 do
slash(math.random(10,200)/30,3,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-3,0)*CFrame.Angles(math.rad(math.random(-10,10)),math.rad(math.random(-360,360)),math.rad(math.random(-10,10))),vt(0.05,0.01,0.05),math.random(25,700)/250,BrickColor.new("White"))
end
local efec = Instance.new("ParticleEmitter",root)
efec.Texture = "rbxassetid://2109052855"
efec.LightEmission = 1
efec.Color = ColorSequence.new(Color3.new(0,0,0))
efec.Rate = 5
efec.Lifetime = NumberRange.new(3)
efec.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,75,0),NumberSequenceKeypoint.new(0.2,60,0),NumberSequenceKeypoint.new(0.6,400,0),NumberSequenceKeypoint.new(0.8,300,0),NumberSequenceKeypoint.new(1,200,0)})
efec.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.1,0.25,0),NumberSequenceKeypoint.new(0.6,0.25,0),NumberSequenceKeypoint.new(1,1,0)})
...
local efec3 = efec:Clone()
efec3.LightEmission = 1
efec3.Color = ColorSequence.new(Color3.new(0,0,0))
efec3.Texture = "rbxassetid://971284039"
efec3.Parent = root
efec3.Rate = 10000
efec3.Drag = 5
efec3.LockedToPart = false
...
efec3.RotSpeed = NumberRange.new(-100,100)
for x = 0, 25 do
CameraEnshaking(8,20)
for i = 0, 1, 0.6 do
swait()
hum.CameraOffset = vt(math.random(-10,10)/30,math.random(-10,10)/30,math.random(-10,10)/30)
sphere2(9,"Add",sorb.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(8,8,8),0.1,0.1,0.1,MAINRUINCOLOR)
sphere2(9,"Add",sorb2.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(8,8,8),0.1,0.1,0.1,MAINRUINCOLOR)
RH.C0=clerp(RH.C0,cf(1,-1.05,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(7),math.rad(0),math.rad(-16)),.8)
LH.C0=clerp(LH.C0,cf(-1,-1.05,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(3),math.rad(0),math.rad(10)),.8)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.8)
...
swait()
hum.CameraOffset = vt(math.random(-10,10)/30,math.random(-10,10)/30,math.random(-10,10)/30)
sphere2(4,"Add",sorb.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(8,8,8),0.1,0.1,0.1,MAINRUINCOLOR)
sphere2(4,"Add",sorb2.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(8,8,8),0.1,0.1,0.1,MAINRUINCOLOR)
RH.C0=clerp(RH.C0,cf(1,-1.05,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(7),math.rad(0),math.rad(-16)),.8)
LH.C0=clerp(LH.C0,cf(-1,-1.05,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(3),math.rad(0),math.rad(10)),.8)
...
hum.CameraOffset = vt(math.random(-20,20)/10*absval/2,math.random(-20,20)/10*absval/2,math.random(-20,20)/10*absval/2)
absval = absval + 0.01
slash(math.random(50,100)/10,2,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(absval*2,0.01,absval*2),math.random(10,300)/1000,BrickColor.new("Really black"))
slash(math.random(10,100)/10,2,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(absval/3,0.01,absval/3),math.random(50,300)/100,BrickColor.new("Really black"))
for i = 0, 1 do
sphere2(9,"Add",root.CFrame*CFrame.new(math.random(-absval*800,absval*800),math.random(-25,25),math.random(-absval*800,absval*800)),vt(1,1,1),0.35,0.35,0.35,MAINRUINCOLOR)
end
sphere2(9,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(40,40,40),absval,absval,absval,MAINRUINCOLOR)
sphere2(9,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(40,5,40),-0.15,absval*60,-0.15,MAINRUINCOLOR)
RH.C0=clerp(RH.C0,cf(1,-0.05,-0.75)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(-30)),.1)
LH.C0=clerp(LH.C0,cf(-1,-0.5,-0.25)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(30)),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1.5 + 0.1 * math.cos(sine / 28))*angles(math.rad(20 - 1 * math.cos(sine / 34)),math.rad(0),math.rad(0)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(55),math.rad(0),math.rad(0)),.1)
...
newbosschatfunc("PREPARE FOR THE END OF THIS WORLD!",MRCL.Color,MRCL2.Color,200)
wait(1.2)
efec.Enabled = false
efec2.Enabled = false
efec3.Enabled = false
CFuncs["Sound"].Create("rbxassetid://1368637781", char, 5, 0.25)
CFuncs["Sound"].Create("rbxassetid://1351572613", char, 8, 0.65)
CFuncs["Sound"].Create("rbxassetid://138677306", char, 8, 0.7)
CFuncs["Sound"].Create("rbxassetid://400765078", char, 8, 0.5)
CFuncs["Sound"].Create("rbxassetid://1368637781", char, 5, 0.5)
CFuncs["Sound"].Create("rbxassetid://1368637781", char, 7.5, 1)
CFuncs["Sound"].Create("rbxassetid://1368605755", char, 7.5, 1)
CFuncs["LongSound"].Create("rbxassetid://138677306", char, 8, 0.5)
CFuncs["LongSound"].Create("rbxassetid://782353443", char, 8, 0.5)
CFuncs["LongSound"].Create("rbxassetid://782353443", char, 8, 0.25)
CameraEnshaking(8,50)
for i = 0, 2 do
CFuncs["Sound"].Create("rbxassetid://763717897", char, 8, 0.4)
CFuncs["Sound"].Create("rbxassetid://1664711478", char, 8, 0.7)
end
for i = 0, 40 do
local dis = CreateParta(char,1,1,"Neon",MAINRUINCOLOR)
dis.CFrame = root.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
...
for i = 0, 60 do
sphere2(1,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(10,10,10),-0.1,absval*300,-0.1,MAINRUINCOLOR)
end
for i = 0, 9, 0.1 do
swait()
hum.CameraOffset = vt(math.random(-20,20)/5*absval,math.random(-20,20)/5*absval,math.random(-20,20)/5*absval)
sphere2(9,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),absval+160,absval+160,absval+160,MAINRUINCOLOR)
for i = 0, 4 do
slash(math.random(10,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(absval/2,0.01,absval/2),math.random(50,5000)/100,BrickColor.new("Really black"))
end
RH.C0=clerp(RH.C0,cf(1,-0.05,-0.75)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(-30)),.1)
...
chaosmode2 = true
rainbowmode = false
RecolorTextAndRename("INSANITY HAS AWOKEN!",MRCL2.Color,MRCL.Color,"Arcade","DM DOKURO - RERURN TO SLIME")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorTextAndRename("CHAOS",MRCL.Color,MRCL2.Color,"Arcade","DM DOKURO - RERURN TO SLIME")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
attack = false
end
...
function ExtCalbeam()
	...
	local radm = math.random(1,3)
if radm == 1 then 
newbosschatfunc("A GOD DOES NOT FEAR DEATH!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then 
newbosschatfunc("You think...you can butcher...ME!?",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then 
newbosschatfunc("THIS IS THE FINAL STRAW!",MRCL.Color,MRCL2.Color,200)
end	
...
function attackone()
	attack = true
symbolizeBlink(sorb,0,2109052855,MRCL.Color,1.5,5,0.9,1614005837,sorb,true,10,1)
symbolizeBlink(sorb,0,2109052855,MRCL2.Color,1.6,5,1,1923591005,sorb,true,10,1)
symbolizeBlink(sorb,0,2092248396,MRCL.Color,3,0,0,0,sorb,true,10,1.25)
symbolizeBlink(sorb,0,2344870656,MRCL2.Color,10,0,0,0,sorb,true,10,1.5)
	for i = 0,1,0.1 do
		swait()
...
sphere(3,"Add",hite.CFrame,vt(0,0,0),0.15,MRCL2)
sphere(3,"Add",hite.CFrame,vt(0,0,0),0.3,MRCL)
shakes(0.1,0.25)
MagniDamage(hite, 11.5, 100,250, 0, "Normal")
for i = 0, 21 do
sphereMK(3,0.2,"Add",hite.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),0.5,0.5,5,-0.005,MRCL,0)
sphereMK(6,0.35,"Add",hite.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),0.5,0.5,5,-0.005,MRCL2,0)
end
...
for i = 0,3.5,0.1 do
swait()
sphereMK(2.5,-4.5,"Add",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),3.5,3.5,45,-0.035,MRCL2,200)
slash(math.random(30,60)/10,5,true,"Round","Add","In",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.5,0.01,0.5),-0.5,MRCL)
RH.C0=clerp(RH.C0,cf(1,-1 - 0.05 * math.cos(sine / 28),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(30)),.2)
LH.C0=clerp(LH.C0,cf(-1,-1 - 0.05 * math.cos(sine / 28),0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(-30)),.2)
...
for i = 0, 24 do
slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(150,350)/250,MRCL)
end
shakes(2,1)
MagniDamage(root,50,200,500,0,"Normal")
coroutine.resume(coroutine.create(function()
for i = 0, 46 do
swait()
sphere2(2,"Add",tors.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),-0.01,7,-0.01,MRCL)
slash(math.random(10,30)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(150,350)/250,MRCL2)
end
end))
...
for i = 0, 14 do
PixelBlock(1,math.random(1,3),"Add",rarm.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL2,0)
end
for i = 0,1,0.1 do
swait()
sphere2(8,"Add",larm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(90),0,0),vt(2.25,0.1,2.25),0.01,0.01,0.01,keptcolor,keptcolor.Color)
...
dis.Touched:connect(function(hit)
	...
	CFuncs["EchoSound"].Create("rbxassetid://782200047", dis, 7, 1.1,0,10,0.15,0.5,1)
shakes(0.1,0.4)
	MagniDamage(dis, 30, 50,150, 0, "Normal")
	sphere2(8,"Add",dis.CFrame,vt(10,1,10),1,0.1,1,keptcolor,keptcolor.Color)
	sphere2(4,"Add",dis.CFrame,vt(1,1,1),0.5,0.5,0.5,MRCL2,MRCL2.Color)
	sphere2(3,"Add",dis.CFrame,vt(1,1,1),0.5,0.5,0.5,MRCL2,MRCL2.Color)
	coroutine.resume(coroutine.create(function()
local eff = Instance.new("ParticleEmitter",dis)
eff.Texture = "rbxassetid://2344870656"
eff.LightEmission = 1
...
trl.LightEmission = 1
trl.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0, 0),NumberSequenceKeypoint.new(1, 1)})
trl.Color = ColorSequence.new(MRCL2.Color)
trl.Lifetime = 0.5
local bv = Instance.new("BodyVelocity")
bv.maxForce = Vector3.new(1e9, 1e9, 1e9)
bv.velocity = disr.CFrame.lookVector*math.random(50,200)
...
eff.Enabled = false
	...
	for i = 0, 9 do
		slash(math.random(10,20)/10,5,true,"Round","Add","Out",dis.CFrame*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-5,5)),math.rad(math.random(-5,5))),vt(0.01,0.01,0.01),math.random(100,200)/250,MRCL2)
	end
for i = 0, 19 do
...
coroutine.resume(coroutine.create(function()
for i, v in pairs(FindNearestHead(elocacenter.CFrame.p, 500)) do
if v:FindFirstChild('Head') then
dmg(v)
end
end
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("This wont be easy to you.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("How about this?",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Swarm!",MRCL.Color,MRCL2.Color,200)
end
...
hum.WalkSpeed = 0
local keptcolor = MRCL
newbosschatfunc("ALL OF YOUR EXISTANCE WILL BE GONE.",MRCL.Color,MRCL2.Color,200)
...
local radm = math.random(1,2)
if radm == 1 then
newbosschatfunc("Plasmatic Burst!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Suffer to the brightness.",MRCL.Color,MRCL2.Color,200)
end
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Crossfire!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Engulf by the flames!",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Burn to death.",MRCL.Color,MRCL2.Color,200)
end
shakes(0.5,0.5)
local vel = Instance.new("BodyPosition", root)
vel.P = 30000
...
attack = true
hum.WalkSpeed = 0 
newbosschatfunc("CHAOTICAL BEAM!",MRCL.Color,2)
RootPart.CFrame = FaceMouse()[1]
...
function BeamOfChaos()
attack = true
hum.WalkSpeed = 0 
newbosschatfunc("OMEGA CHAOTICAL BEAM!",MRCL.Color,MRCL2.Color,200)
RootPart.CFrame = FaceMouse()[1]
CFuncs["Sound"].Create("rbxassetid://1368598393", rarm, 8, 1)
for i = 0, 5, 0.1 do
swait()
block(8,"Add",rarm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),0.01,0.01,0.01,MRCL,Color3.new(0,0,0))
RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(1),math.rad(0),math.rad(-10)),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1.25),math.rad(0),math.rad(6)),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1)*angles(math.rad(0),math.rad(0),math.rad(60)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(20),math.rad(-5),math.rad(-60)),.1)
...
CFuncs["Sound"].Create("rbxassetid://335657174", rarm, 8, 1)
for i = 0, 14 do
slash(math.random(10,40)/10,5,true,"Round","Add","Out",rarm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(25,150)/250,MRCL)
end
block(3,"Add",rarm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),0.05,0.05,0.05,MRCL,Color3.new(0,0,0))
block(3,"Add",rarm.CFrame*CFrame.new(0,-2,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),0.1,0.15,0.1,MRCL,Color3.new(0,0,0))
local keptcolor = MRCL
local orb = Instance.new("Part", char)
        orb.BrickColor = MRCL2
        orb.CanCollide = false
        orb.FormFactor = 3
        orb.Name = "Ring"
        orb.Material = "Neon"
...
orb.CFrame = orb.CFrame*CFrame.new(0,1,0)
CFuncs["LongSound"].Create("rbxassetid://1545630949", char, 2.5, 1)
local bgui,imgc = createBGCircle(300,orb,MRCL2.Color)
bgui.AlwaysOnTop = true
imgc.ImageTransparency = 1
imgc.Image = "rbxassetid://2325939897"
local over = false
...
shakes(15,5)
for i = 0, 99 do
local dis = CreateParta(char,1,1,"Neon",MRCL2)
dis.CFrame = orb.CFrame*CFrame.new(math.random(-5,5),math.random(-5,5),math.random(-5,5))*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
local at1 = Instance.new("Attachment",dis)
at1.Position = vt(-25000,0,0)
local at2 = Instance.new("Attachment",dis)
...
eff.Texture = "rbxassetid://363275192"
eff.LightEmission = 0.95
eff.Color = ColorSequence.new(MRCL2)
eff.Rate = 100
eff.Lifetime = NumberRange.new(1)
eff.Size = NumberSequence.new({NumberSequenceKeypoint.new(0,40,0),NumberSequenceKeypoint.new(1,45,0)})
eff.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(0.5,0.5,0),NumberSequenceKeypoint.new(1,1,0)})
...
sphere2(5,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(10,10,10),5,5,5,MRCL2)
sphere2(5,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(10,10,10),1,35,1,MRCL2)
sphere2(5,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(10,10,10),0,50,0,MRCL2)
sphere2(5,"Add",orb.CFrame,vt(10,100000,10),2,2,2,MRCL2)
end
over = true
orb:Destroy()
end))
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Gotcha!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Die.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Think faster.",MRCL.Color,MRCL2.Color,200)
end
coroutine.resume(coroutine.create(function()
...
newbosschatfunc("Your existance will be gone!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Next time, dont mess with me.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Nothing will be with you after you're gone!",MRCL.Color,MRCL2.Color,200)
end
coroutine.resume(coroutine.create(function()
...
function Chaos2Annihilation()
attack = true
hum.WalkSpeed = 0
newbosschatfunc("HAHAHAHAHAHAHAHAHAHAHAHA!",MRCL.Color,MRCL2.Color,200)
for i = 0, 10, 0.1 do
swait()
PixelBlockNeg(1,math.random(1,2),"Add",sorb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL,0)
...
sphere(1,"Add",sorb.CFrame,vt(0,0,0),0.25,MRCL)
sphere(2,"Add",sorb.CFrame,vt(0,0,0),0.25,MRCL)
sphere(3,"Add",sorb.CFrame,vt(0,0,0),0.25,MRCL)
sphere(4,"Add",sorb.CFrame,vt(0,0,0),0.25,MRCL)
sphere(5,"Add",sorb.CFrame,vt(0,0,0),0.25,MRCL)
for i = 0, 10, 0.1 do
swait()
PixelBlockNeg(1,0.01,"Add",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),6,6,6,0.12,MRCL,0)
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 2 * math.cos(sine / 39))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(10 + 6 * math.cos(sine / 31))),.1)
...
sphere(1,"Add",elocacenter.CFrame,vt(0,0,0),1,MRCL)
sphere(2,"Add",elocacenter.CFrame,vt(0,0,0),1,MRCL)
sphere(3,"Add",elocacenter.CFrame,vt(0,0,0),1,MRCL)
sphere(4,"Add",elocacenter.CFrame,vt(0,0,0),1,MRCL)
sphere(5,"Add",elocacenter.CFrame,vt(0,0,0),1,MRCL)
for i = 0, 99 do
swait()
...
eloca1.CFrame = elocacenter.CFrame*CFrame.new(lookavec,0,0)
PixelBlockNeg(2,0,"Add",eloca1.CFrame*CFrame.Angles(math.rad(90 + math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),5,5,5,0.05,MRCL,-2)

eloca2.CFrame = elocacenter.CFrame*CFrame.new(-lookavec,0,0)
PixelBlockNeg(2,0,"Add",eloca2.CFrame*CFrame.Angles(math.rad(90 + math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),5,5,5,0.05,MRCL,-2)

eloca3.CFrame = elocacenter.CFrame*CFrame.new(0,0,lookavec)
PixelBlockNeg(2,0,"Add",eloca3.CFrame*CFrame.Angles(math.rad(90 + math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),5,5,5,0.05,MRCL,-2)

eloca4.CFrame = elocacenter.CFrame*CFrame.new(0,0,-lookavec)
PixelBlockNeg(2,0,"Add",eloca4.CFrame*CFrame.Angles(math.rad(90 + math.random(-10,10)),math.rad(math.random(-10,10)),math.rad(math.random(-10,10))),5,5,5,0.05,MRCL,-2)
end
...
sphere(1,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(2,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(3,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(4,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(5,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
...
for x = 0, 4 do
for i = 0, 9 do
sphereMK(0.5,0,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),10,10,100000,0,MRCL,0)
end
...
swait()
PixelBlockNeg(1,math.random(1,2),"Add",sorb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL,0)
PixelBlockNeg(1,math.random(1,2),"Add",sorb2.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL,0)
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 2 * math.cos(sine / 39))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(10 + 6 * math.cos(sine / 31))),.1)
...
local speedearn = 0
CFuncs["Sound"].Create("rbxassetid://166032807", char, 5,0.2)
...
for i = 0, 4 do 
sphereMK(1+speedearn,speedearn,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),5,5,10*speedearn,-0.05,MRCL,0)
end
PixelBlock(1,speedearn,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1*speedearn/10,1*speedearn/10,1*speedearn/10,0.02*speedearn/10,MRCL,0)
orbm.Scale = orbm.Scale + vt(scaled,scaled,scaled)
PixelBlockNeg(1,math.random(1,2),"Add",sorb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL,0)
PixelBlockNeg(1,math.random(1,2),"Add",sorb2.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),1,1,1,0.02,MRCL,0)
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 2 * math.cos(sine / 39))),.1)
...
coroutine.resume(coroutine.create(function()
if enableddam == true then
for i, v in pairs(FindNearestHead(orb.CFrame.p, 1247)) do
if v:FindFirstChild('Head') then
dmg(v)
end
end
...
shakes(7,40)
MagniDamage(elocacenter, 1247, 5000000,99999999, 0, "Normal")
CFuncs["Sound"].Create("rbxassetid://167115397", char, 5,1)
CFuncs["Sound"].Create("rbxassetid://138677306", char, 5,0.8)
...
CFuncs["Sound"].Create("rbxassetid://1396112757", char, 5, 0.7)
CFuncs["Sound"].Create("rbxassetid://429123896", char, 5, 0.85)
CFuncs["Sound"].Create("rbxassetid://1202657035", char, 5, 0.8)
CFuncs["Sound"].Create("rbxassetid://133047927", char, 5,0.77)
sphere(1,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(2,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(3,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(4,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
sphere(5,"Add",elocacenter.CFrame,vt(0,0,0),10,MRCL)
for i = 0, 99 do
PixelBlock(1,math.random(50,1000),"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),20,20,20,0.4,MRCL,0)
PixelBlock(2,math.random(250,1000),"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),10,10,10,0.2,MRCL,0)
end
for i = 0, 24 do
sphereMK(0.5,0,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),10,10,100000,0,MRCL,0)
sphereMK(1,2,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),25,25,100,-0.5,MRCL,0)
sphereMK(2,4,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),25,25,75,-0.25,MRCL,0)
sphereMK(3,6,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),25,25,50,-0.25,MRCL,0)
sphereMK(4,8,"Add",elocacenter.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),25,25,25,-0.25,MRCL,0)
end
game:GetService("Debris"):AddItem(orb, 10)
hum.WalkSpeed = storehumanoidWS
attack = false
...
if rd == 1 then
newbosschatfunc("This is your end!",MRCL.Color,MRCL2.Color,200)
elseif rd == 2 then
newbosschatfunc("Pathetic.",MRCL.Color,MRCL2.Color,200)
elseif rd == 3 then
newbosschatfunc("Time to end this.",MRCL.Color,MRCL2.Color,200)
end
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Galactical Beam!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Dodge this.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Aren't you familiar?",MRCL.Color,MRCL2.Color,200)
end
coroutine.resume(coroutine.create(function()
for i = 0, 0 do
swait(10)
...
swait()
truescale = truescale + 0.2
truescale2 = truescale2 + 0.1
hum.CameraOffset = vt(math.random(-10,10)/100,math.random(-10,10)/100,math.random(-10,10)/100)
slash(5,5,true,"Round","Add","Out",root.CFrame*CFrame.new(0,75,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(3,0.01,3),-3,BrickColor.new("Royal purple"))
block(10,"Add",root.CFrame*CFrame.new(0,75,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(truescale,truescale,truescale),0.01,0.01,0.01,BrickColor.new("Magenta"),BrickColor.new("Magenta").Color)
block(10,"Add",root.CFrame*CFrame.new(0,75,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(truescale,truescale,truescale),0.01,0.01,0.01,BrickColor.new("Royal purple"),BrickColor.new("Royal purple").Color)
RH.C0=clerp(RH.C0,cf(1,-0.5,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(5),math.rad(-10)),.5)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(1),math.rad(5)),.5)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,1)*angles(math.rad(0),math.rad(0),math.rad(40)),.5)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(20),math.rad(0),math.rad(-40)),.5)
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Singularity Void!",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("Be one with darkness.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Don't bother me.",MRCL.Color,MRCL2.Color,200)
end
CFuncs["Sound"].Create("rbxassetid://1208650519", char, 2.5, 1)
local poste = 3
local rotation = 0
...
local radm = math.random(1,3)
if radm == 1 then
newbosschatfunc("Act faster.",MRCL.Color,MRCL2.Color,200)
elseif radm == 2 then
newbosschatfunc("You'll be dusted out.",MRCL.Color,MRCL2.Color,200)
elseif radm == 3 then
newbosschatfunc("Warped Dash!",MRCL.Color,MRCL2.Color,200)
end
...
hum.WalkSpeed = 0
hum.JumpPower = 0
newbosschatfunc("Turn into ashes.",MRCL.Color,MRCL2.Color,200)
CFuncs["Sound"].Create("rbxassetid://1208650519", tors, 5, 0.5)
local poste = 3
local rotation = 0
local rate = 0
local bgui,imgc = createBGCircle(200,root,MRCL.Color)
bgui.AlwaysOnTop = true
imgc.ImageTransparency = 1
imgc.Image = "rbxassetid://2076519836"
for i = 0, 224 do
...
game:GetService("Debris"):AddItem(loc, 5)
root.CFrame = root.CFrame + root.CFrame.lookVector*500
hum.WalkSpeed = storehumanoidWS
hum.JumpPower = 50
attack = false
end
---- Universal's Abilities
function ChaosAnnihilation()
	attack = true
	hum.WalkSpeed = 0
	CFuncs["Sound"].Create("rbxassetid://247615928", char, 1.5, 1)
	newbosschatfunc("DIE DIE DIE DIE!",MRCL.Color,MRCL2.Color,200)
	for i = 0, 9, 0.1 do
		swait()
...
dmg(v)
		...
		slash(math.random(30,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(500,2500)/250,MRCL)
		slash(math.random(30,50)/10,5,true,"Round","Add","Out",root.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(500,2500)/250,MRCL)
...
--MRCL2 = BrickColor.new("Really black")
        orb.BrickColor = BrickColor.new("Navy blue")
        orb.CanCollide = false
        orb.FormFactor = 3
        orb.Name = "Ring"
        orb.Material = "Neon"
...
for i = 0, 49 do
slash(math.random(10,30)/10,5,true,"Round","Add","Out",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),math.random(150,2500)/250,BrickColor.new("Really black"))
end
coroutine.resume(coroutine.create(function()
if enableddam == true then
for i, v in pairs(FindNearestHead(root.CFrame.p, 1000000000)) do
...
bv.Parent = dis
game:GetService("Debris"):AddItem(dis, 5)
sphere2(15,"Add",orb.CFrame,vt(1.25,1.25,1.25),45,45,45,BrickColor.new("Navy blue"))
for i = 0, 2 do
slash(15,5,true,"Round","Add","Out",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),25,BrickColor.new("Really black"))
slash(15,5,true,"Round","Add","Out",orb.CFrame*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(0.01,0.01,0.01),50,BrickColor.new("Really black"))
end
orbm.Scale = orbm.Scale + vt(10,10,10)
orb.Transparency = orb.Transparency + 0.005
end
...
MRCL = BrickColor.new("Really black")
MRCL2 = BrickColor.new("Dark indigo")
RecolorTextAndRename("DEMENTIA",MRCL.Color,MRCL2.Color,"Antique","Nhelv - Silentroom Ã é§¿")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
...
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://1564523997",0,1,1.25)
MRCL = BrickColor.new("Institutional white")
MRCL2 = BrickColor.new("Really black")
RecolorTextAndRename("SOLITUDE",MRCL2.Color,MRCL.Color,"Fantasy","Astronaut 13")
RecolorThing(MRCL2.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
...
chaosmode = true
chaosmode2 = false
newTheme("rbxassetid://2525700576",0,1.01,2.25)
MRCL = BrickColor.new("Really black")
MRCL2 = BrickColor.new("Really black")
...
if k == "j" and attack == false and ModeOfGlitch ~= 102 then
ModeOfGlitch = 102
storehumanoidWS = 100
hum.WalkSpeed = 100
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://3584584668",0,1,1.50)
MRCL = BrickColor.new("Pink")
MRCL2 = BrickColor.new("Hot pink")
RecolorTextAndRename("Love <3",MRCL2.Color,MRCL.Color,"Cartoon","Shibayan Records - Tiny Little Adiantum")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorTextAndRename("LOVE",MRCL2.Color,MRCL.Color,"Cartoon","Shibayan Records - Tiny Little Adiantum")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
...
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://798163149",0,1.01,1.75)
MRCL = BrickColor.new("Lime green")
...
if k == "r" and attack == false and ModeOfGlitch ~= 53 then
ModeOfGlitch = 53
storehumanoidWS = 300
hum.WalkSpeed = 300
rainbowmode = false
...
newThemeCust("rbxassetid://2489826464",0,1,2.5)
RecolorTextAndRename("CALAMITAS HAS AWOKEN!",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - STAINED, BRUTAL CALAMITY")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorTextAndRename("CALAMITAS",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - STAINED, BRUTAL CALAMITY")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "t" and attack == false and ModeOfGlitch ~= 63 then
ModeOfGlitch = 63
storehumanoidWS = 200
hum.WalkSpeed = 200
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://739066292",0,1.01,1.25)
MRCL = BrickColor.new("Magenta")
MRCL2 = BrickColor.new("Dark indigo")
RecolorTextAndRename("AZURE X",MRCL2.Color,MRCL.Color,"Antique","xi - Dreadnought")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
...
newbosschatfunc("HAHAHAHAHAHAHAHA!!",MRCL.Color,MRCL2.Color,200)
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
...
if k == "j" and attack == false and ModeOfGlitch ~= 74 then
ModeOfGlitch = 74
storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = false
chaosmode = false
chaosmode2 = false
newThemeCust("rbxassetid://627722878",0,1,1.25)
MRCL = BrickColor.new("Lime green")
MRCL2 = BrickColor.new("Really black")
RecolorTextAndRename("CREEPER?",MRCL2.Color,MRCL.Color,"Antique","Revenge - Captainsparklez")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
wait(3)
newbosschatfunc("Creeper? Aw man...",MRCL.Color,MRCL2.Color,200)
wait(2)
newbosschatfunc("So we back in the mine, got a pickaxe",MRCL.Color,MRCL2.Color,200)
wait(3)
newbosschatfunc("Swinging from side to side, side side to side",MRCL.Color,MRCL2.Color,200)
end
end
...
if k == "j" and attack == false and ModeOfGlitch ~= 105 then
                 ModeOfGlitch = 105
storehumanoidWS = 500
hum.WalkSpeed = 500
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://598625751",0,1,2.2)
MRCL = BrickColor.new("Institutional white")
MRCL2 = BrickColor.new("Toothpaste")
RecolorTextAndRename("LIGHTSPEED",MRCL.Color,MRCL2.Color,"Arcade","xi - Blue Zenith")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
if etypemodes == "E" then
if k == "q" and attack == false and ModeOfGlitch ~= 16 then
 ModeOfGlitch = 16
storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://2071274388",0,1,1.2)
MRCL = BrickColor.new("Bright bluish green")
MRCL2 = BrickColor.new("Pastel light blue")
RecolorTextAndRename("COMMOTIAUS",MRCL.Color,MRCL2.Color,"SciFi","DM DOKURO - Cosmic Disgust")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "e" and attack == false and ModeOfGlitch ~= 26 then
                 ModeOfGlitch = 26
storehumanoidWS = 12
hum.WalkSpeed = 12
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://692083837",0,1,1.2)
MRCL = BrickColor.new("Earth green")
MRCL2 = BrickColor.new("Forest green")
RecolorTextAndRename("DURABITINE",MRCL.Color,MRCL2.Color,"Bodoni","Example - Last Ones Standing (Doctor P Remix)")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "r" and attack == false and ModeOfGlitch ~= 36 then
                 ModeOfGlitch = 36
storehumanoidWS = 19
hum.WalkSpeed = 19
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://436447939",0,1,1.2)
MRCL = BrickColor.new("Mulberry")
MRCL2 = BrickColor.new("Royal purple")
RecolorTextAndRename("ENCHANTER",MRCL.Color,MRCL2.Color,"Antique","9H, 9P, 9D || Imaginary")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "t" and attack == false and ModeOfGlitch ~= 46 then
                 ModeOfGlitch = 46
storehumanoidWS = 9
hum.WalkSpeed = 9
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://209322206",0,1,1.2)
MRCL = BrickColor.new("Really black")
MRCL2 = BrickColor.new("Really black")
RecolorTextAndRename("SILENTIAC",MRCL.Color,MRCL2.Color,"Cartoon","???")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "y" and attack == false and ModeOfGlitch ~= 56 then
                 ModeOfGlitch = 56
storehumanoidWS = 37
hum.WalkSpeed = 37
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://1880845619",0,1,1.1)
MRCL = BrickColor.new("Really black")
MRCL2 = BrickColor.new("Really red")
RecolorTextAndRename("METALEMPSYSIS",MRCL.Color,MRCL2.Color,"SciFi","Kobaryo - Delete The World")
RecolorThing(MRCL2.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "u" and attack == false and ModeOfGlitch ~= 66 then
                 ModeOfGlitch = 66
storehumanoidWS = 37
hum.WalkSpeed = 37
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://1290419263",0,1,0.9)
MRCL = BrickColor.new("Rust")
MRCL2 = BrickColor.new("Cocoa")
RecolorTextAndRename("AMBUSTUME",MRCL.Color,MRCL2.Color,"Bodoni","Kiseijuu - Next To You ")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "f" and attack == false and ModeOfGlitch ~= 76 then
ModeOfGlitch = 76
storehumanoidWS = 20
hum.WalkSpeed = 20
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://343860759",0,0.5,1.2)
MRCL = BrickColor.new("Really black")
MRCL2 = BrickColor.new("Black")
RecolorTextAndRename("CURSED",MRCL.Color,MRCL2.Color,"Bodoni","Pony Island OST 02 - Enter Pony")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
if etypemodes == "O" then
if k == "q" and attack == false and ModeOfGlitch ~= 18 then
ModeOfGlitch = 18
storehumanoidWS = 20
hum.WalkSpeed = 20
hum.JumpPower = 50
...
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://1382488262",0,1,1.5)
MRCL = BrickColor.new("Reddish lilac")
MRCL2 = BrickColor.new("Institutional white")
RecolorTextAndRename("PANDORA",MRCL2.Color,MRCL.Color,"Fantasy","Negaren: Operation Delgonflange")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "e" and attack == false and ModeOfGlitch ~= 28 then
ModeOfGlitch = 28
storehumanoidWS = 50
hum.WalkSpeed = 50
hum.JumpPower = 50
...
chaosmode = false
chaosmode2 = false
--local fuckyou = math.random(1,3)
--if fuckyou == 1 then
newTheme("rbxassetid://1138145518",0,1,5)
--elseif fuckyou == 2 then
--newTheme("rbxassetid://470452718",0,1,3)
--elseif fuckyou == 3 then
--newTheme("rbxassetid://214698997",0,1,10)
--end
MRCL = BrickColor.new("Lime green")
MRCL2 = BrickColor.new("Hot pink")
RecolorTextAndRename("insert edgy name and music here",MRCL2.Color,MRCL.Color,"Cartoon","who cares")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "r" and attack == false and ModeOfGlitch ~= 38 and script.owner.Value == "gian0508" then
ModeOfGlitch = 38
storehumanoidWS = 250
hum.WalkSpeed = 250
hum.JumpPower = 50
...
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://1379882084",0,1,2.25)
MRCL = BrickColor.new("Institutional white")
MRCL2 = BrickColor.new("Really black")
RecolorTextAndRename("gian",MRCL2.Color,MRCL.Color,"Arcade","Payday 2 - 8 Bits Are Scary")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
if k == "t" and attack == false and ModeOfGlitch ~= 48 then
ModeOfGlitch = 48
storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = false
chaosmode = false
chaosmode2 = false
newTheme("rbxassetid://366694533",0,1,1.25)
MRCL = BrickColor.new("Gold")
MRCL2 = BrickColor.new("Really black")
RecolorTextAndRename("NO TIME",MRCL2.Color,MRCL.Color,"Gotham","TLT - I Got No Time")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
end
end
...
elseif k == "z" and attack == false and ModeOfGlitch == 28 then
whofuckingcares()
elseif k == "c" and attack == false and ModeOfGlitch == 102 and script.owner.Value == "gian0508" then
FuckMeSidewaysAndCallMeGay()
elseif k == "x" and attack == false and ModeOfGlitch == 102 then
ChooseODer()
elseif k == "z" and attack == false and ModeOfGlitch == 36 then
desstomp()
elseif k == "z" and attack == false and ModeOfGlitch == 102 then
shytaunty()
elseif k == "x" and attack == false and ModeOfGlitch == 43 then
EternalChaosOrb()
elseif k == "c" and attack == false and ModeOfGlitch == 43 then
RapidBurst2()
elseif k == "z" and attack == false and ModeOfGlitch == 22 then
HeavenlyDisk()
elseif k == "z" and attack == false and ModeOfGlitch == 32 then
CorruptionEvent()
elseif k == "z" and attack == false and ModeOfGlitch == 13 then
NuclearEvent()
elseif k == "z" and attack == false and ModeOfGlitch == 54 then
crazedannihilation()
elseif k == "z" and attack == false and ModeOfGlitch == 42 then
RapidBurst()
elseif k == "m" and attack == false and ModeOfGlitch == 42 then
InsanityAwakening()
...
roldbeam()
elseif k == "x" and attack == false and ModeOfGlitch == 72 then
roldbeam2()
elseif k == "z" and attack == false and ModeOfGlitch == 23 then
CalMets()
elseif k == "z" and attack == false and ModeOfGlitch == 53 then
SupCalMets()
elseif k == "z" and attack == false and ModeOfGlitch == 33 then
CatCalMets()
...
WarpedDash()
elseif k == "z" and attack == false and ModeOfGlitch == 105 then
LightDash()
end
...
EternalChaosOrb()
elseif k == "c" and attack == false and ModeOfGlitch == 42 then
BeamOfChaos()
elseif k == "v" and attack == false and ModeOfGlitch == 42 then
ChaosAnnihilation()
elseif k == "x" and attack == false and ModeOfGlitch == 23 then
ExtCalbeam()
elseif k == "m" and attack == false and ModeOfGlitch == 23 then
ascendCalamity()
elseif k == "v" and attack == false and ModeOfGlitch == 63 then
AzureXVANISHMENT()
elseif k == "z" and attack == false and ModeOfGlitch == 63 then
supsmiter()
elseif k == "x" and attack == false and ModeOfGlitch == 53 then
SupExtCalbeam()
elseif k == "x" and attack == false and ModeOfGlitch == 33 then
CatExtCalbeam()
elseif k == "x" and attack == false and ModeOfGlitch == 35 then
BinaryBLINK()
elseif k == "m" and attack == false and ModeOfGlitch == 9 then
...
BeamOfDeath()
elseif k == "z" and attack == false and ModeOfGlitch == 43 then
Chaos2Annihilation()
elseif k == "z" and attack == false and ModeOfGlitch == 76 then
CursedSlash()
end
if k == "n" and etypemodes == "O" then
etypemodes = "U"
nedm.Text = "MODETYPES: UNIVERSAL"
...
elseif k == "n" and etypemodes == "G" then
etypemodes = "E"
nedm.Text = "MODETYPES: ETHEREAL"
elseif k == "n" and etypemodes == "E" then
etypemodes = "O"
nedm.Text = "MODETYPES: EXTRAS"
end
...
if k == "p" and enabledshake == false then
enabledshake = true
nedc.Text = "Shakes: Enabled"
elseif k == "p" and enabledshake == true then
enabledshake = false
nedc.Text = "Shakes: Disabled"
end
if k == "k" and enabledchat == false then
enabledchat = true
nedo.Text = "Boss Chat: Enabled"
elseif k == "k" and enabledchat == true then
enabledchat = false
nedo.Text = "Boss Chat: Disabled"
end
end)
...
while true do
swait()
if ModeOfGlitch ~= 4 and ModeOfGlitch ~= 8 and ModeOfGlitch ~= 14 and ModeOfGlitch ~= 24 and ModeOfGlitch ~= 34 and ModeOfGlitch ~= 44 and ModeOfGlitch ~= 54 and ModeOfGlitch ~= 64 and ModeOfGlitch ~= 26 and ModeOfGlitch ~= 36 and ModeOfGlitch ~= 42 then
...
elseif ModeOfGlitch == 4 or ModeOfGlitch == 8 or ModeOfGlitch == 14 or ModeOfGlitch == 24 or ModeOfGlitch == 34 or ModeOfGlitch == 44 or ModeOfGlitch == 64 then
...
elseif ModeOfGlitch == 54 or ModeOfGlitch == 42 then
sphereMK(20,math.random(10,50)/45,"Add",root.CFrame*CFrame.new(math.random(-160,160),-5,math.random(-160,160))*CFrame.Angles(math.rad(90 + math.random(-15,15)),math.rad(math.random(-15,15)),math.rad(math.random(-15,15))),2.75,2.75,100,0,MRCL2,0)
sphereMK(20,math.random(10,50)/45,"Add",root.CFrame*CFrame.new(math.random(-160,160),-5,math.random(-160,160))*CFrame.Angles(math.rad(90 + math.random(-15,15)),math.rad(math.random(-15,15)),math.rad(math.random(-15,15))),2.75,2.75,100,0,MRCL,0)
elseif ModeOfGlitch == 36 then
sphereMK(6,math.random(5,15)/45,"Add",root.CFrame*CFrame.new(math.random(-10,10),-5,math.random(-10,10))*CFrame.Angles(math.rad(90 + math.random(-3,3)),math.rad(math.random(-3,3)),math.rad(math.random(-3,3))),0.2,0.2,3,0,MRCL2,0)
sphereMK(6,math.random(5,15)/45,"Add",root.CFrame*CFrame.new(math.random(-10,10),-5,math.random(-10,10))*CFrame.Angles(math.rad(90 + math.random(-3,3)),math.rad(math.random(-3,3)),math.rad(math.random(-3,3))),0.2,0.2,3,0,MRCL,0)
elseif ModeOfGlitch == 26 then
sphereMK(1,0.2,"Add",root.CFrame*CFrame.new(math.random(-10,10),3,math.random(-10,10))*CFrame.Angles(math.rad(-90),math.rad(0),math.rad(0)),0.2,0.2,3,0,MRCL2,0)
end
end
end))
coroutine.resume(coroutine.create(function()
...
hed.pandora.Union.Transparency = 1
hed.pandora.Union2.Transparency = 1
hed.pandora.Detail.Transparency = 1
hed.pandora.Hat.Transparency = 1
...
hed.pandora.Union.Transparency = 0
hed.pandora.Union2.Transparency = 0
hed.pandora.Detail.Transparency = 0
hed.pandora.Hat.Transparency = 0
end
end
end))
...
while true do
swait()
if ModeOfGlitch ~= 53 then
calsword.MeshPart2.Transparency = 1
calsword.MeshPart.Transparency = 1
elseif ModeOfGlitch == 53 then
calsword.MeshPart2.Transparency = 0
calsword.MeshPart.Transparency = 0
end
end
end))
...
swait()
if ModeOfGlitch == 53 then
if char.ero.TimePosition >= 190.941782711551582 and char.ero.TimePosition <= 191 then
MRCL = BrickColor.new("Pastel Blue")
MRCL2 = BrickColor.new("Pastel light blue")
RecolorTextAndRename("LAMENT",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - STAINED, BRUTAL CALAMITY")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)	
RecolorTextAndRename("CALAMITAS",MRCL2.Color,MRCL.Color,"Antique","DM DOKURO - STAINED, BRUTAL CALAMITY")
RecolorThing(MRCL.Color,MRCL2.Color,MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
calsword.MeshPart2.Transparency = 1
...
local whocares = script.FlangeSoundEffect:Clone()
coroutine.resume(coroutine.create(function()
while true do
swait()
if ModeOfGlitch ~= 28 then
whocares.Parent = hed
elseif ModeOfGlitch == 28 then
whocares.Parent = kan
end
end
end))
...
if ModeOfGlitch == 54 then
local random = math.random(1,2)
if random == 1 then
RecolorTextAndRename("CRAZED",MRCL2.Color,MRCL.Color,"Code","??? - ???")
elseif random == 2 then
RecolorTextAndRename("CRAZED",MRCL.Color,MRCL2.Color,"Code","??? - ???")
end
modet.Position = UDim2.new(0,math.random(-3,3),0,math.random(-3,3))
modet.Rotation = -2 * math.cos(sine / 5) + math.random(-5,5)
end
if ModeOfGlitch == 28 then
modet.Position = UDim2.new(0,math.random(-20,20),0,math.random(-20,20))
modet.Rotation = -5 * math.cos(sine / 5) + math.random(-50,50)
end
if chaosmode2 == true then
RecolorTextAndRename("INSANITY",MRCL.Color,Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)),"Arcade","DM DOKURO - BLOOD COAGULANT")
rtsc(MRCL.Color,Color3.fromRGB(math.random(0,255),math.random(0,255),math.random(0,255)),MRCL,MRCL,MRCL,1,MRCL,1,MRCL,false,false)
modet.Position = UDim2.new(0,math.random(-5,5),0,math.random(-5,5))
modet.Rotation = -5 * math.cos(sine / 1) + math.random(-5,5)
end
techc.Rotation = techc.Rotation + 1
circl.Rotation = rval
circl2.Rotation = -rval
imgl2.Rotation = rval
techc2.Rotation = -rval
ned.Rotation = 0 - 2 * math.cos(sine / 24)
nedx.Rotation = 5 - 2 * math.cos(sine / 50)
nedc.Rotation = 5 - 2 * math.cos(sine / 69)
nedo.Rotation = -9 + 4 * math.cos(sine / 43)
...
cred.Position = UDim2.new(0.325,0 + 5 * math.cos(sine / 36),0 - 0.01 * math.cos(sine / 20),0 - 2 * math.cos(sine / 50))
cred.Rotation = 0 + -2.5 * math.cos(sine / 60)
...
fr3.Position = UDim2.new(0, 0, 0 + 0 * math.cos(sine / 35), 0)
fr4.Position = UDim2.new(0, 0, 0.05 - 0 * math.cos(sine / 36), 0)
fr3.Rotation = 0 + -1 * math.cos(sine / 25)
fr4.Rotation = 0 - -1 * math.cos(sine / 22)
midr.Rotation = rval
midr2.Rotation = -rval
ned.Position = UDim2.new(0.7,0 - 10 * math.cos(sine / 32),0.8,0 - 10 * math.cos(sine / 45))
CameraManager()
swait()
if ModeOfGlitch ~= 4 and ModeOfGlitch ~= 8 and ModeOfGlitch ~= 42 and ModeOfGlitch ~= 43 and ModeOfGlitch ~= 14 and ModeOfGlitch ~= 24 and ModeOfGlitch ~= 34 and ModeOfGlitch ~= 44 and ModeOfGlitch ~= 54 and ModeOfGlitch ~= 64 and ModeOfGlitch ~= 75 and ModeOfGlitch ~= 105 and ModeOfGlitch ~= 28 then
rval = rval + 1
elseif ModeOfGlitch == 4 or ModeOfGlitch == 8 or ModeOfGlitch == 14 or ModeOfGlitch == 24 or ModeOfGlitch == 33 or ModeOfGlitch == 34 or ModeOfGlitch == 44 or ModeOfGlitch == 54 or ModeOfGlitch == 64 or ModeOfGlitch == 75 then
rval = rval + 5
elseif ModeOfGlitch == 105 then
rval = rval + 20
elseif ModeOfGlitch == 28 then
rval = rval + math.random(-100,100)
elseif ModeOfGlitch == 42 then
rval = rval + math.random(-15,15)
elseif ModeOfGlitch == 43 then
rval = rval + math.random(-30,30)
end
...
if ModeOfGlitch == 5 or ModeOfGlitch == 7 or ModeOfGlitch == 8 or ModeOfGlitch == 62 or ModeOfGlitch == 82 or ModeOfGlitch == 23 or ModeOfGlitch == 84 or ModeOfGlitch == 53 or ModeOfGlitch == 33  or ModeOfGlitch == 33 or ModeOfGlitch == 14 or ModeOfGlitch == 24 or ModeOfGlitch == 34 or ModeOfGlitch == 44 or ModeOfGlitch == 54 or ModeOfGlitch == 64 or ModeOfGlitch == 65 or ModeOfGlitch == 85 or ModeOfGlitch == 38 then
...
if ModeOfGlitch ~= 5 and ModeOfGlitch ~= 7 and ModeOfGlitch ~= 62 and ModeOfGlitch ~= 82 and ModeOfGlitch ~= 36 and ModeOfGlitch ~= 56 and ModeOfGlitch ~= 66 and ModeOfGlitch ~= 46 and ModeOfGlitch ~= 54 and ModeOfGlitch ~= 38 then
...
elseif ModeOfGlitch == 5 or ModeOfGlitch == 7 or ModeOfGlitch == 62 or ModeOfGlitch == 82 or ModeOfGlitch == 66 or ModeOfGlitch == 38 then
...
elseif ModeOfGlitch == 56 or ModeOfGlitch == 54 then
...
if ModeOfGlitch == 5 or ModeOfGlitch == 7 or ModeOfGlitch == 8 or ModeOfGlitch == 62 or ModeOfGlitch == 82 or ModeOfGlitch == 23 or ModeOfGlitch == 84 or ModeOfGlitch == 53 or ModeOfGlitch == 33  or ModeOfGlitch == 14 or ModeOfGlitch == 24 or ModeOfGlitch == 34 or ModeOfGlitch == 44 or ModeOfGlitch == 64 or ModeOfGlitch == 65 or ModeOfGlitch == 85 or ModeOfGlitch == 38 then
if hitfloor ~= nil then
	effar.Enabled = true
...
if hitfloor ~= nil then
	effar.Enabled = true
	effar.Color = ColorSequence.new(MRCL.Color)
	sphere2(4,"Add",root.CFrame*CFrame.new(0,-3,0),vt(0,1,0),0.5,0.01,0.5,MRCL2)
slash(math.random(100,200)/10,10,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-2.5,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(0.05,0.01,0.05),math.random(5,500)/250,MRCL)
slash(math.random(100,200)/10,10,true,"Round","Add","Out",root.CFrame*CFrame.new(0,-2.5,0)*CFrame.Angles(math.rad(math.random(-5,5)),math.rad(math.random(-360,360)),math.rad(math.random(-5,5))),vt(0.05,0.01,0.05),math.random(5,500)/250,BrickColor.new("White"))
elseif hitfloor == nil then
	effar.Enabled = false
end
...
sphere2(1.5,"Add",root.CFrame*CFrame.new(0,-3,0),vt(0.1 + kan.PlaybackLoudness/50,0.5,0.1 + kan.PlaybackLoudness/50),0.1,0.01,0.1,BrickColor.new("Institutional white"),Color3.fromRGB(r,g,b))
RH.C0=clerp(RH.C0,cf(1,-1 - 0.1 * math.cos(sine / 20),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-6),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(1 - 2 * math.cos(sine / 32))),.1)
...
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),1.5 + 0.5 * math.cos(sine / 20))*angles(math.rad(0 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(-36)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(13 - 2 * math.cos(sine / 37)),math.rad(0 + 1 * math.cos(sine / 58)),math.rad(36 + 2 * math.cos(sine / 53))),.1)
RW.C0=clerp(RW.C0,cf(1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(3 + 7 * math.cos(sine / 79)),math.rad(-20 - 3 * math.cos(sine / 53)),math.rad(70 + 10 * math.cos(sine / 73))),.1)
LW.C0=clerp(LW.C0,cf(-1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(15 - 3 * math.cos(sine / 73)),math.rad(2 - 1 * math.cos(sine / 55)),math.rad(27 + 6 * math.cos(sine / 33))),.1)
...
elseif ModeOfGlitch == 84 then
local snap = math.random(1,3)
if snap == 1 then
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(19 + math.random(-3,15)),math.rad(-3 + math.random(-3,15)),math.rad(math.random(0,0))),1)
end	
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 5 * math.cos(sine / 51))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(10 + 3 * math.cos(sine / 44))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),1.5 + 0.5 * math.cos(sine / 20))*angles(math.rad(0 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(-36)),.1)
...
sphere2(8,"Add",rarm.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),-0.01,0.05,-0.01,MRCL,MRCL.Color)
sphere2(8,"Add",larm.CFrame*CFrame.new(0,-1,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),-0.01,0.05,-0.01,MRCL,MRCL.Color)
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-10 - 2 * math.cos(sine / 39))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-3),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(10 + 6 * math.cos(sine / 31))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),1.5 + 0.5 * math.cos(sine / 20))*angles(math.rad(0 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(-20)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(13 - 2 * math.cos(sine / 37)),math.rad(0 + 1 * math.cos(sine / 58)),math.rad(20 + 2 * math.cos(sine / 53))),.1)
...
elseif ModeOfGlitch == 105 then
RH.C0=clerp(RH.C0,cf(1,-0.35 - 0.1 * math.cos(sine / 20),-0.5 - 0.1 * math.cos(sine / 20))*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-2.5),math.rad(-20),math.rad(30)),.25)
LH.C0=clerp(LH.C0,cf(-1,- 1- 0.1 * math.cos(sine / 20),0 - 0.1 * math.cos(sine / 20))*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-2.5),math.rad(0),math.rad(10)),.25)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.01 * math.cos(sine / 34),-0.75 + 0.1 * math.cos(sine / 20))*angles(math.rad(30),math.rad(0),math.rad(20)),.25)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-15 - 5.5 * math.cos(sine / 28)),math.rad(0),math.rad(-20)),.25)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*angles(math.rad(40),math.rad(-8),math.rad(-10)),.25)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*angles(math.rad(-50),math.rad(0),math.rad(-30)),.25)
...
elseif ModeOfGlitch == 66 then -- soon to change anim
...
block2(10,4,"Add",CFrame.new(RootPart.Position)*CFrame.Angles(math.random(-120,120),math.random(-120,120),math.random(-120,120))*CFrame.new(0,0,math.random(-150,150)/10),vt(math.random(10,80)/30,math.random(10,80)/30,math.random(10,80)/30),0,0,0,MRCL,MRCL2.Color)
block2(10,4,"Add",CFrame.new(RootPart.Position)*CFrame.Angles(math.random(-120,120),math.random(-120,120),math.random(-120,120))*CFrame.new(0,0,math.random(-150,150)/10),vt(math.random(10,80)/30,math.random(10,80)/30,math.random(10,80)/30),0,0,0,MRCL,MRCL2.Color)
...
elseif ModeOfGlitch == 76 then -- Cursed by Unfair
local rsiz = math.random(1,2)
sphereMK(math.random(3,6),math.random(-25,25)/750,"Add",sorb2.CFrame*CFrame.new(math.random(-20,20)/50,math.random(-20,20)/50,math.random(-20,20)/50)*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/10,rsiz/10,rsiz/10,0,MRCL,0)
sphereMK(math.random(6,9),math.random(-10,10)/750,"Add",sorb2.CFrame*CFrame.new(math.random(-5,5)/50,math.random(-5,5)/50,math.random(-5,5)/50)*CFrame.Angles(math.rad(90 + math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),rsiz/3,rsiz/3,rsiz/3,0,MRCL,0)
RH.C0=clerp(RH.C0,cf(1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(-5),math.rad(90),math.rad(-5)),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - 0.05 * math.cos(sine / 32),0)*angles(math.rad(5),math.rad(-90),math.rad(5)),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0.01 + 0.001 * math.cos(sine / 32),0 + 0.05 * math.cos(sine / 32))*angles(math.rad(2 - 2 * math.cos(sine / 32)),math.rad(0),math.rad(-20 - 1 * math.cos(sine / 44))),.1)
...
elseif ModeOfGlitch == 28 then
RH.C0=clerp(RH.C0,cf(1,-1 - math.random(-5,5) * math.cos(sine / 20),0)*angles(math.rad(0),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*angles(math.rad(math.random(-360,360) + math.random(-360,360) * math.cos(sine / 20)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360) - math.random(-360,360) * math.cos(sine / 20))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - math.random(-5,5) * math.cos(sine / 20),0)*angles(math.rad(0),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))*angles(math.rad(math.random(-360,360) - math.random(-360,360) * math.cos(sine / 20)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360) + math.random(-360,360) * math.cos(sine / 20))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*angles(math.rad(1 - math.random(-360,360) * math.cos(sine / 20)),math.rad(0),math.rad(36)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(math.random(-69,69) + math.random(-69,69) * math.cos(sine / 25)),math.rad(0),math.rad(math.random(-360,360) - math.random(-360,360) * math.cos(sine / 67))),.1)
RW.C0=clerp(RW.C0,cf(1,0.5 - math.random(-5,5) * math.cos(sine / 18),-0.65)*angles(math.rad(math.random(-360,360) + math.random(-360,360) * math.cos(sine / 38)),math.rad(math.random(-360,360) + math.random(-69,69) * math.cos(sine / 31)),math.rad(math.random(-360,360) + math.random(-360,360) * math.cos(sine / 25))),.1)
LW.C0=clerp(LW.C0,cf(-1,0.45 - math.random(-5,5) * math.cos(sine / 18),0.5)*angles(math.rad(math.random(-360,360) + math.random(-360,360) * math.cos(sine / 38)),math.rad(math.random(-360,360) - math.random(-360,360) * math.cos(sine / 31)),math.rad(math.random(-360,360) - math.random(-360,360) * math.cos(sine / 25))),.1)
elseif ModeOfGlitch == 18 then
Animation_Speed = 3
RootJoint.C0=clerp(RootJoint.C0,ROOTC0* cf(0 - 0.04 * math.sin(sine / 24), 0 + 0.04 * math.sin(sine / 12), 0 + 0.05 * math.cos(sine / 12)) * angles(RAD(0 - 2.5 * math.sin(sine / 12)), RAD(0 - 2.5 * math.sin(sine / 24)), RAD(0)), 1 / Animation_Speed)
Torso.Neck.C0=clerp(Torso.Neck.C0,NECKC0* cf(0, 0, 0 + ((1.1) - 1)) * angles(RAD(25 - 4 * math.sin(sine / 12)), RAD(0), RAD(0)), 1 / Animation_Speed)
			RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 1) * angles(RAD(-35), RAD(-25 + 2.5 * math.sin(sine / 12)), RAD(-55 + 2.5 * math.sin(sine / 12))) * RIGHTSHOULDERC0, 1 / Animation_Speed)
			LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 1) * angles(RAD(-35), RAD(25 - 2.5 * math.sin(sine / 12)), RAD(55 - 2.5 * math.sin(sine / 12))) * LEFTSHOULDERC0, 1 / Animation_Speed)
			RH.C0 = clerp(RH.C0, cf(1, -1 + 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(RAD(0 - 2.5 * math.sin(sine / 12)), RAD(75), RAD(0)) * angles(RAD(-2 - 2.5 * math.sin(sine / 24)), RAD(0), RAD(0)), 1 / Animation_Speed)
			LH.C0 = clerp(LH.C0, cf(-1, -1 - 0.06 * math.sin(sine / 24) - 0.05 * math.cos(sine / 12), -0.01) * angles(RAD(0 - 2.5 * math.sin(sine / 12)), RAD(-75), RAD(0)) * angles(RAD(-2 + 2.5 * math.sin(sine / 24)), RAD(0), RAD(0)), 1 / Animation_Speed)
		RootJoint.C1 = clerp(RootJoint.C1, ROOTC0 * CF(0, 0, 0) * angles(RAD(0), RAD(0), RAD(0)), 0.2 / Animation_Speed)
		Neck.C1 = clerp(Neck.C1, CF(0, -0.5, 0) * angles(RAD(-90), RAD(0), RAD(180)) * angles(RAD(0), RAD(0), RAD(0)), 1 / Animation_Speed)
		RH.C1 = clerp(RH.C1, CF(0.5, 1, 0) * angles(RAD(0), RAD(90), RAD(0)) * angles(RAD(0), RAD(0), RAD(0)), 1 / Animation_Speed)
		LH.C1 = clerp(LH.C1, CF(-0.5, 1, 0) * angles(RAD(0), RAD(-90), RAD(0)) * angles(RAD(0), RAD(0), RAD(0)), 1 / Animation_Speed)
end
end
elseif torvel>2 and torvel<22 and hitfloor~=nil then
Anim="Walk"
if attack==false and ModeOfGlitch ~= 76 and ModeOfGlitch ~= 102 and ModeOfGlitch ~= 46 and ModeOfGlitch ~= 36 and ModeOfGlitch ~= 28 and ModeOfGlitch ~= 43 then
...
elseif ModeOfGlitch == 28 then
RH.C0=clerp(RH.C0,cf(1,-1 - math.random(-5,5) * math.cos(sine / 20),0)*angles(math.rad(0),math.rad(math.random(-68,49)),math.rad(0))*angles(math.rad(-3 + 2 * math.cos(sine / 20)),math.rad(-17),math.rad(-1 - 2 * math.cos(sine / 20))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - math.random(-5,5) * math.cos(sine / 20),0)*angles(math.rad(0),math.rad(math.random(-59,64)),math.rad(0))*angles(math.rad(-3 - 2 * math.cos(sine / 20)),math.rad(5.5),math.rad(-1 + 2 * math.cos(sine / 20))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*angles(math.rad(1 - math.random(-360,360) * math.cos(sine / 20)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(math.random(-69,69) + math.random(-69,69) * math.cos(sine / 25)),math.rad(0),math.rad(math.random(-69,69) - 3 * math.cos(sine / 67))),.1)
RW.C0=clerp(RW.C0,cf(1,0.5 - math.random(-5,5) * math.cos(sine / 18),-0.65)*angles(math.rad(math.random(-69,69) + math.random(-69,69) * math.cos(sine / 38)),math.rad(math.random(-69,69) + math.random(-69,69) * math.cos(sine / 31)),math.rad(math.random(-69,69) + math.random(-69,69) * math.cos(sine / 25))),.1)
LW.C0=clerp(LW.C0,cf(-1,0.45 - math.random(-5,5) * math.cos(sine / 18),0.5)*angles(math.rad(math.random(-90,60) + 3 * math.cos(sine / 38)),math.rad(0 - 2 * math.cos(sine / 31)),math.rad(34 - 1 * math.cos(sine / 25))),.1)
end
elseif torvel>=22 and hitfloor~=nil then
Anim="Run"
if attack==false then
if ModeOfGlitch ~= 5 and ModeOfGlitch ~= 7 and ModeOfGlitch ~= 8 and ModeOfGlitch ~= 62 and ModeOfGlitch ~= 82 and ModeOfGlitch ~= 23 and ModeOfGlitch ~= 84 and ModeOfGlitch ~= 33 and ModeOfGlitch ~= 14 and ModeOfGlitch ~= 24 and ModeOfGlitch ~= 34 and ModeOfGlitch ~= 44 and ModeOfGlitch ~= 54 and ModeOfGlitch ~= 64 and ModeOfGlitch ~= 65 and ModeOfGlitch ~= 85 and ModeOfGlitch ~= 53 and ModeOfGlitch ~= 28 and ModeOfGlitch ~= 38 then
...
elseif ModeOfGlitch == 5 or ModeOfGlitch == 7 or ModeOfGlitch == 8 or ModeOfGlitch == 62 or ModeOfGlitch == 82 or ModeOfGlitch == 23 or ModeOfGlitch == 84 or ModeOfGlitch == 53 or ModeOfGlitch == 33  or ModeOfGlitch == 14 or ModeOfGlitch == 24 or ModeOfGlitch == 34 or ModeOfGlitch == 44 or ModeOfGlitch == 54 or ModeOfGlitch == 64 or ModeOfGlitch == 65 or ModeOfGlitch == 85 or ModeOfGlitch == 38 then
