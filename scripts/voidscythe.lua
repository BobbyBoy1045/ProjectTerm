...
local hat = Player.Character['Dark Matter Scythe'].Handle
--Variables
local plr = Player
...
hat.AccessoryWeld:Destroy() -- -45, 105, -15
Align(hat,char.Scythe.Handle,Vector3.new(1.6, -2, 0),Vector3.new(-68, 105, -15))
