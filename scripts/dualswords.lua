...
if not game.Players.LocalPlayer.Character:FindFirstChild("BladeMasterAccessory") and not game.Players.LocalPlayer.Character:FindFirstChild("ShadowBladeMasterAccessory") then
	game.StarterGui:SetCore("SendNotification",{
		Title = "Project: Terminate",
		Text = "Missing Hats.",
	})
...
if game.Players.LocalPlayer.Character:FindFirstChild("Anti") then
	...
	return
		...
		local char = player.Character.Rig
		...
		local pos = Player.Character.Rig.Torso.Position
