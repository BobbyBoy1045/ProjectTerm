local script = game:GetObjects("rbxassetid://8638665426")[1]
-- originally wanted to make 2 shotguns sadly i failed so i keep it with single gun
...
if not game.Players.LocalPlayer.Character:FindFirstChild("METALXLIGHTSEER77Accessory") then
	game.StarterGui:SetCore("SendNotification",{
		Title = "Project: Terminate",
		Text = "Missing Hat.",
	})
...
function Swait(NUMBER)
	game:GetService("RunService").Stepped:Wait(NUMBER)
end
...
local Hat1 = game.Players.LocalPlayer.Character["METALXLIGHTSEER77Accessory"].Handle
Hat1.AccessoryWeld:Destroy()
Align(Hat1,Character.Gun.Handle,Vector3.new(1, 0.1, 0),Vector3.new(-45,90,0))
